...
if(k=g.length)for(h=f;h&&k--;){c=g.shift();h=h[c]}}catch(l){}return h},ajaxOptions:{},from:function(f){return new function(j,h){if(typeof j=="string")j=b.data(j);var c=this,g=j,k=true,l=false,a=h,r=/[\$,%]/g,x=null,y=null,E=false,Q="",K=[],O=true;if(typeof j=="object"&&j.push){if(j.length>0)O=typeof j[0]!="object"?false:true}else throw"data provides is not an array";this._hasData=function(){return g===null?false:g.length===0?false:true};this._getStr=function(m){var o=[];l&&o.push("jQuery.trim(");
o.push("String("+m+")");l&&o.push(")");k||o.push(".toLowerCase()");return o.join("")};this._strComp=function(m){return typeof m=="string"?".toString()":""};this._group=function(m,o){return{field:m.toString(),unique:o,items:[]}};this._toStr=function(m){if(l)m=b.trim(m);k||(m=m.toLowerCase());return m=m.toString().replace(/\\/g,"\\\\").replace(/\"/g,'\\"')};this._funcLoop=function(m){var o=[];b.each(g,function(q,B){o.push(m(B))});return o};this._append=function(m){if(a===null)a="";else a+=Q===""?" && ":
Q;if(E)a+="!";a+="("+m+")";E=false;Q=""};this._setCommand=function(m,o){x=m;y=o};this._resetNegate=function(){E=false};this._repeatCommand=function(m,o){if(x===null)return c;if(m!==null&&o!==null)return x(m,o);if(y===null)return x(m);if(!O)return x(m);return x(y,m)};this._equals=function(m,o){return c._compare(m,o,1)===0};this._compare=function(m,o,q){if(q===undefined)q=1;if(m===undefined)m=null;if(o===undefined)o=null;if(m===null&&o===null)return 0;if(m===null&&o!==null)return 1;if(m!==null&&o===
null)return-1;if(!k&&typeof m!=="number"&&typeof o!=="number"){m=String(m).toLowerCase();o=String(o).toLowerCase()}if(m<o)return-q;if(m>o)return q;return 0};this._performSort=function(){if(K.length!==0)g=c._doSort(g,0)};this._doSort=function(m,o){var q=K[o].by,B=K[o].dir,T=K[o].type,J=K[o].datefmt;if(o==K.length-1)return c._getOrder(m,q,B,T,J);o++;q=c._getGroup(m,q,B,T,J);B=[];for(T=0;T<q.length;T++){J=c._doSort(q[T].items,o);for(var D=0;D<J.length;D++)B.push(J[D])}return B};this._getOrder=function(m,
o,q,B,T){var J=[],D=[],W=q=="a"?1:-1,U,ga;if(B===undefined)B="text";ga=B=="float"||B=="number"||B=="currency"||B=="numeric"?function(S){S=parseFloat(String(S).replace(r,""));return isNaN(S)?0:S}:B=="int"||B=="integer"?function(S){return S?parseFloat(String(S).replace(r,"")):0}:B=="date"||B=="datetime"?function(S){return b.jgrid.parseDate(T,S).getTime()}:b.isFunction(B)?B:function(S){S||(S="");return b.trim(String(S).toUpperCase())};b.each(m,function(S,aa){U=o!==""?b.jgrid.getAccessor(aa,o):aa;if(U===
undefined)U="";U=ga(U,aa);D.push({vSort:U,index:S})});D.sort(function(S,aa){S=S.vSort;aa=aa.vSort;return c._compare(S,aa,W)});B=0;for(var ca=m.length;B<ca;){q=D[B].index;J.push(m[q]);B++}return J};this._getGroup=function(m,o,q,B,T){var J=[],D=null,W=null,U;b.each(c._getOrder(m,o,q,B,T),function(ga,ca){U=b.jgrid.getAccessor(ca,o);if(U===undefined)U="";if(!c._equals(W,U)){W=U;D!==null&&J.push(D);D=c._group(o,U)}D.items.push(ca)});D!==null&&J.push(D);return J};this.ignoreCase=function(){k=false;return c};
this.useCase=function(){k=true;return c};this.trim=function(){l=true;return c};this.noTrim=function(){l=false;return c};this.execute=function(){var m=a,o=[];if(m===null)return c;b.each(g,function(){eval(m)&&o.push(this)});g=o;return c};this.data=function(){return g};this.select=function(m){c._performSort();if(!c._hasData())return[];c.execute();if(b.isFunction(m)){var o=[];b.each(g,function(q,B){o.push(m(B))});return o}return g};this.hasMatch=function(){if(!c._hasData())return false;c.execute();return g.length>
0};this.andNot=function(m,o,q){E=!E;return c.and(m,o,q)};this.orNot=function(m,o,q){E=!E;return c.or(m,o,q)};this.not=function(m,o,q){return c.andNot(m,o,q)};this.and=function(m,o,q){Q=" && ";if(m===undefined)return c;return c._repeatCommand(m,o,q)};this.or=function(m,o,q){Q=" || ";if(m===undefined)return c;return c._repeatCommand(m,o,q)};this.isNot=function(m){E=!E;return c.is(m)};this.is=function(m){c._append("this."+m);c._resetNegate();return c};this._compareValues=function(m,o,q,B,T){var J;J=
O?"jQuery.jgrid.getAccessor(this,'"+o+"')":"this";if(q===undefined)q=null;var D=q,W=T.stype===undefined?"text":T.stype;if(q!==null)switch(W){case "int":case "integer":D=isNaN(Number(D))||D===""?"0":D;J="parseInt("+J+",10)";D="parseInt("+D+",10)";break;case "float":case "number":case "numeric":D=String(D).replace(r,"");D=isNaN(Number(D))||D===""?"0":D;J="parseFloat("+J+")";D="parseFloat("+D+")";break;case "date":case "datetime":D=String(b.jgrid.parseDate(T.newfmt||"Y-m-d",D).getTime());J='jQuery.jgrid.parseDate("'+
T.srcfmt+'",'+J+").getTime()";break;default:J=c._getStr(J);D=c._getStr('"'+c._toStr(D)+'"')}c._append(J+" "+B+" "+D);c._setCommand(m,o);c._resetNegate();return c};this.equals=function(m,o,q){return c._compareValues(c.equals,m,o,"==",q)};this.notEquals=function(m,o,q){return c._compareValues(c.equals,m,o,"!==",q)};this.isNull=function(m,o,q){return c._compareValues(c.equals,m,null,"===",q)};this.greater=function(m,o,q){return c._compareValues(c.greater,m,o,">",q)};this.less=function(m,o,q){return c._compareValues(c.less,
m,o,"<",q)};this.greaterOrEquals=function(m,o,q){return c._compareValues(c.greaterOrEquals,m,o,">=",q)};this.lessOrEquals=function(m,o,q){return c._compareValues(c.lessOrEquals,m,o,"<=",q)};this.startsWith=function(m,o){var q=o===undefined||o===null?m:o;q=l?b.trim(q.toString()).length:q.toString().length;if(O)c._append(c._getStr("jQuery.jgrid.getAccessor(this,'"+m+"')")+".substr(0,"+q+") == "+c._getStr('"'+c._toStr(o)+'"'));else{q=l?b.trim(o.toString()).length:o.toString().length;c._append(c._getStr("this")+
...
if(e){var d=b("table:first",g.bDiv),i,n;if(d[0].rows.length)try{n=(i=d[0].rows[1])?b(i).outerHeight()||g.prevRowHeight:g.prevRowHeight}catch(p){n=g.prevRowHeight}if(n){g.prevRowHeight=n;var A=c.rowNum;i=g.scrollTop=g.bDiv.scrollTop;var s=Math.round(d.position().top)-i,F=s+d.height();n*=A;var t,z,v;if(F<e&&s<=0&&(c.lastpage===undefined||parseInt((F+i+n-1)/n,10)<=c.lastpage)){z=parseInt((e-F+n-1)/n,10);if(F>=0||z<2||c.scroll===true){t=Math.round((F+i)/n)+1;s=-1}else s=1}if(s>0){t=parseInt(i/n,10)+1;
z=parseInt((i+e)/n,10)+2-t;v=true}if(z)if(!(c.lastpage&&t>c.lastpage||c.lastpage==1||t===c.page&&t===c.lastpage))if(g.hDiv.loading)g.timer=setTimeout(g.populateVisible,c.scrollTimeout);else{c.page=t;if(v){g.selectionPreserver(d[0]);g.emptyRows(g.bDiv,false,false)}g.populate(z)}}}},scrollGrid:function(e){if(c.scroll){var d=g.bDiv.scrollTop;if(g.scrollTop===undefined)g.scrollTop=0;if(d!=g.scrollTop){g.scrollTop=d;g.timer&&clearTimeout(g.timer);g.timer=setTimeout(g.populateVisible,c.scrollTimeout)}}g.hDiv.scrollLeft=
g.bDiv.scrollLeft;if(c.footerrow)g.sDiv.scrollLeft=g.bDiv.scrollLeft;e&&e.stopPropagation()},selectionPreserver:function(e){var d=e.p,i=d.selrow,n=d.selarrrow?b.makeArray(d.selarrrow):null,p=e.grid.bDiv.scrollLeft,A=d.gridComplete;d.gridComplete=function(){d.selrow=null;d.selarrrow=[];if(d.multiselect&&n&&n.length>0)for(var s=0;s<n.length;s++)n[s]!=i&&b(e).jqGrid("setSelection",n[s],false);i&&b(e).jqGrid("setSelection",i,false);e.grid.bDiv.scrollLeft=p;d.gridComplete=A;d.gridComplete&&A()}}};if(this.tagName.toUpperCase()!=
"TABLE")alert("Element is not a table");else{b(this).empty().attr("tabindex","1");this.p=c;var k,l,a;if(this.p.colNames.length===0)for(k=0;k<this.p.colModel.length;k++)this.p.colNames[k]=this.p.colModel[k].label||this.p.colModel[k].name;if(this.p.colNames.length!==this.p.colModel.length)alert(b.jgrid.errors.model);else{var r=b("<div class='ui-jqgrid-view'></div>"),x,y=b.browser.msie?true:false,E=b.browser.webkit||b.browser.safari?true:false;a=this;a.p.direction=b.trim(a.p.direction.toLowerCase());
if(b.inArray(a.p.direction,["ltr","rtl"])==-1)a.p.direction="ltr";l=a.p.direction;b(r).insertBefore(this);b(this).appendTo(r).removeClass("scroll");var Q=b("<div class='ui-jqgrid ui-widget ui-widget-content ui-corner-all'></div>");b(Q).insertBefore(r).attr({id:"gbox_"+this.id,dir:l});b(r).appendTo(Q).attr("id","gview_"+this.id);x=y&&b.browser.version<=6?'<iframe style="display:block;position:absolute;z-index:-1;filter:Alpha(Opacity=\'0\');" src="javascript:false;"></iframe>':"";b("<div class='ui-widget-overlay jqgrid-overlay' id='lui_"+
this.id+"'></div>").append(x).insertBefore(r);b("<div class='loading ui-state-default ui-state-active' id='load_"+this.id+"'>"+this.p.loadtext+"</div>").insertBefore(r);b(this).attr({cellspacing:"0",cellpadding:"0",border:"0",role:"grid","aria-multiselectable":!!this.p.multiselect,"aria-labelledby":"gbox_"+this.id});var K=function(e,d){e=parseInt(e,10);return isNaN(e)?d?d:0:e},O=function(e,d,i,n,p,A){var s=a.p.colModel[e],F=s.align,t='style="',z=s.classes,v=s.name,u=[];if(F)t+="text-align:"+F+";";
if(s.hidden===true)t+="display:none;";if(d===0)t+="width: "+g.headers[e].width+"px;";else if(s.cellattr&&b.isFunction(s.cellattr))if((e=s.cellattr.call(a,p,i,n,s,A))&&typeof e==="string"){e=e.replace(/style/i,"style").replace(/title/i,"title");if(e.indexOf("title")>-1)s.title=false;if(e.indexOf("class")>-1)z=undefined;u=e.split("style");if(u.length===2){u[1]=b.trim(u[1].replace("=",""));if(u[1].indexOf("'")===0||u[1].indexOf('"')===0)u[1]=u[1].substring(1);t+=u[1].replace(/'/gi,'"')}else t+='"'}if(!u.length){u[0]=
"";t+='"'}t+=(z!==undefined?' class="'+z+'"':"")+(s.title&&i?' title="'+b.jgrid.stripHtml(i)+'"':"");t+=' aria-describedby="'+a.p.id+"_"+v+'"';return t+u[0]},m=function(e){return e===undefined||e===null||e===""?"&#160;":a.p.autoencode?b.jgrid.htmlEncode(e):e+""},o=function(e,d,i,n,p){var A=a.p.colModel[i];if(typeof A.formatter!=="undefined"){e={rowId:e,colModel:A,gid:a.p.id,pos:i};d=b.isFunction(A.formatter)?A.formatter.call(a,d,e,n,p):b.fmatter?b.fn.fmatter(A.formatter,d,e,n,p):m(d)}else d=m(d);
...
d);a.p._index[n]=i}},ga=function(e,d,i,n,p){var A=new Date,s=a.p.datatype!="local"&&a.p.loadonce||a.p.datatype=="xmlstring",F=a.p.datatype=="local"?"local":"xml";if(s){a.p.data=[];a.p._index={};a.p.localReader.id="_id_"}a.p.reccount=0;if(b.isXMLDoc(e)){if(a.p.treeANode===-1&&!a.p.scroll){W(d,false,true);i=1}else i=i>1?i:1;var t,z,v=0,u,G=0,R=0,M=0,L,N=[],Y,I={},w,C,H=[],ha=a.p.altRows===true?" "+a.p.altclass:"";a.p.xmlReader.repeatitems||(N=J(F));L=a.p.keyIndex===false?a.p.xmlReader.id:a.p.keyIndex;
...
' style="display:none;"';for(;Z<V;){w=e[Z];C=F(w,ra+Z);t=i===0?0:i+1;t=(t+Z)%2==1?ha:"";H.push("<tr"+oa+' id="'+C+'" tabindex="-1" role="row" class ="ui-widget-content jqgrow ui-row-'+a.p.direction+""+t+'">');if(a.p.rownumbers===true){H.push(T(0,Z,a.p.page,a.p.rowNum));M=1}if(a.p.multiselect===true){H.push(B(C,M,Z));G=1}if(a.p.subGrid===true){H.push(b(a).jqGrid("addSubGridCell",G+M,Z+i));R=1}if(a.p.xmlReader.repeatitems){Y||(Y=D(G+R+M));var Ba=b(a.p.xmlReader.cell,w);b.each(Y,function(ea){var $=Ba[this];
if(!$)return false;u=$.textContent||$.text;I[a.p.colModel[ea+G+R+M].name]=u;H.push(q(C,u,ea+G+R+M,Z+i,w))})}else for(t=0;t<N.length;t++){u=b(N[t],w).text();I[a.p.colModel[t+G+R+M].name]=u;H.push(q(C,u,t+G+R+M,Z+i,w))}H.push("</tr>");if(a.p.grouping){t=a.p.groupingView.groupField.length;for(var xa=[],ya=0;ya<t;ya++)xa.push(I[a.p.groupingView.groupField[ya]]);ia=b(a).jqGrid("groupingPrepare",H,xa,ia,I);H=[]}if(s||a.p.treeGrid===true){I._id_=C;a.p.data.push(I);a.p._index[C]=a.p.data.length-1}if(a.p.gridview===
false){b("tbody:first",d).append(H.join(""));p&&a.p.afterInsertRow.call(a,C,I,w);H=[]}I={};v++;Z++;if(v==fa)break}}if(a.p.gridview===true){z=a.p.treeANode>-1?a.p.treeANode:0;if(a.p.grouping){b(a).jqGrid("groupingRender",ia,a.p.colModel.length);ia=null}else a.p.treeGrid===true&&z>0?b(a.rows[z]).after(H.join("")):b("tbody:first",d).append(H.join(""))}if(a.p.subGrid===true)try{b(a).jqGrid("addSubGrid",G+M)}catch(Ha){}a.p.totaltime=new Date-A;if(v>0)if(a.p.records===0)a.p.records=V;H=null;if(a.p.treeGrid===
true)try{b(a).jqGrid("setTreeNode",z+1,v+z+1)}catch(Ia){}if(!a.p.treeGrid&&!a.p.scroll)a.grid.bDiv.scrollTop=0;a.p.reccount=v;a.p.treeANode=-1;a.p.userDataOnFooter&&b(a).jqGrid("footerData","set",a.p.userData,true);if(s){a.p.records=V;a.p.lastpage=Math.ceil(V/fa)}n||a.updatepager(false,true);if(s)for(;v<V;){w=e[v];C=F(w,v);if(a.p.xmlReader.repeatitems){Y||(Y=D(G+R+M));var Ea=b(a.p.xmlReader.cell,w);b.each(Y,function(ea){var $=Ea[this];if(!$)return false;u=$.textContent||$.text;I[a.p.colModel[ea+G+
R+M].name]=u})}else for(t=0;t<N.length;t++){u=b(N[t],w).text();I[a.p.colModel[t+G+R+M].name]=u}I._id_=C;a.p.data.push(I);a.p._index[C]=a.p.data.length-1;I={};v++}}},ca=function(e,d,i,n,p){var A=new Date;if(e){if(a.p.treeANode===-1&&!a.p.scroll){W(d,false,true);i=1}else i=i>1?i:1;var s,F=a.p.datatype!="local"&&a.p.loadonce||a.p.datatype=="jsonstring";if(F){a.p.data=[];a.p._index={};a.p.localReader.id="_id_"}a.p.reccount=0;if(a.p.datatype=="local"){d=a.p.localReader;s="local"}else{d=a.p.jsonReader;
s="json"}var t=0,z,v,u=[],G,R=0,M=0,L=0,N,Y,I={},w,C,H=[],ha=a.p.altRows===true?" "+a.p.altclass:"";a.p.page=b.jgrid.getAccessor(e,d.page)||0;N=b.jgrid.getAccessor(e,d.total);a.p.lastpage=N===undefined?1:N;a.p.records=b.jgrid.getAccessor(e,d.records)||0;a.p.userData=b.jgrid.getAccessor(e,d.userdata)||{};d.repeatitems||(G=u=J(s));s=a.p.keyIndex===false?d.id:a.p.keyIndex;if(u.length>0&&!isNaN(s)){if(a.p.remapColumns&&a.p.remapColumns.length)s=b.inArray(s,a.p.remapColumns);s=u[s]}(Y=b.jgrid.getAccessor(e,
d.root))||(Y=[]);N=Y.length;e=0;var V=parseInt(a.p.rowNum,10),Z=a.p.scroll?b.jgrid.randId():1;if(p)V*=p+1;var ia=b.isFunction(a.p.afterInsertRow),fa={},ra="";if(a.p.grouping&&a.p.groupingView.groupCollapse===true)ra=' style="display:none;"';for(;e<N;){p=Y[e];C=b.jgrid.getAccessor(p,s);if(C===undefined){C=Z+e;if(u.length===0)if(d.cell)C=b.jgrid.getAccessor(p,d.cell)[s]||C}z=i===1?0:i;z=(z+e)%2==1?ha:"";H.push("<tr"+ra+' id="'+C+'" tabindex="-1" role="row" class= "ui-widget-content jqgrow ui-row-'+
a.p.direction+""+z+'">');if(a.p.rownumbers===true){H.push(T(0,e,a.p.page,a.p.rowNum));L=1}if(a.p.multiselect){H.push(B(C,L,e));R=1}if(a.p.subGrid){H.push(b(a).jqGrid("addSubGridCell",R+L,e+i));M=1}if(d.repeatitems){if(d.cell)p=b.jgrid.getAccessor(p,d.cell);G||(G=D(R+M+L))}for(v=0;v<G.length;v++){z=b.jgrid.getAccessor(p,G[v]);H.push(q(C,z,v+R+M+L,e+i,p));I[a.p.colModel[v+R+M+L].name]=z}H.push("</tr>");if(a.p.grouping){z=a.p.groupingView.groupField.length;v=[];for(var oa=0;oa<z;oa++)v.push(I[a.p.groupingView.groupField[oa]]);
fa=b(a).jqGrid("groupingPrepare",H,v,fa,I);H=[]}if(F||a.p.treeGrid===true){I._id_=C;a.p.data.push(I);a.p._index[C]=a.p.data.length-1}if(a.p.gridview===false){b("#"+b.jgrid.jqID(a.p.id)+" tbody:first").append(H.join(""));ia&&a.p.afterInsertRow.call(a,C,I,p);H=[]}I={};t++;e++;if(t==V)break}if(a.p.gridview===true){w=a.p.treeANode>-1?a.p.treeANode:0;if(a.p.grouping)b(a).jqGrid("groupingRender",fa,a.p.colModel.length);else a.p.treeGrid===true&&w>0?b(a.rows[w]).after(H.join("")):b("#"+b.jgrid.jqID(a.p.id)+
" tbody:first").append(H.join(""))}if(a.p.subGrid===true)try{b(a).jqGrid("addSubGrid",R+L)}catch(Ba){}a.p.totaltime=new Date-A;if(t>0)if(a.p.records===0)a.p.records=N;if(a.p.treeGrid===true)try{b(a).jqGrid("setTreeNode",w+1,t+w+1)}catch(xa){}if(!a.p.treeGrid&&!a.p.scroll)a.grid.bDiv.scrollTop=0;a.p.reccount=t;a.p.treeANode=-1;a.p.userDataOnFooter&&b(a).jqGrid("footerData","set",a.p.userData,true);if(F){a.p.records=N;a.p.lastpage=Math.ceil(N/V)}n||a.updatepager(false,true);if(F)for(;t<N&&Y[t];){p=
Y[t];C=b.jgrid.getAccessor(p,s);if(C===undefined){C=Z+t;if(u.length===0)if(d.cell)C=b.jgrid.getAccessor(p,d.cell)[s]||C}if(p){if(d.repeatitems){if(d.cell)p=b.jgrid.getAccessor(p,d.cell);G||(G=D(R+M+L))}for(v=0;v<G.length;v++){z=b.jgrid.getAccessor(p,G[v]);I[a.p.colModel[v+R+M+L].name]=z}I._id_=C;a.p.data.push(I);a.p._index[C]=a.p.data.length-1;I={}}t++}}},S=function(){function e(w){var C=0,H,ha,V;if(w.groups!==undefined)for(H=0;H<w.groups.length;H++){try{e(w.groups[H])}catch(Z){alert(Z)}C++}if(w.rules!==
undefined){if(C>0){var ia=u.select();u=b.jgrid.from(ia)}try{for(H=0;H<w.rules.length;H++){V=w.rules[H];ha=w.groupOp.toString().toUpperCase();if(v[V.op]&&V.field){if(C>0&&ha&&ha==="OR")u=u.or();u=v[V.op](u,ha)(V.field,V.data,n[V.field])}C++}}catch(fa){alert(fa)}}}var d,i=false,n={},p=[],A=[],s,F,t;if(b.isArray(a.p.data)){var z=a.p.grouping?a.p.groupingView:false;b.each(a.p.colModel,function(){F=this.sorttype||"text";if(F=="date"||F=="datetime"){if(this.formatter&&typeof this.formatter==="string"&&
this.formatter=="date"){s=this.formatoptions&&this.formatoptions.srcformat?this.formatoptions.srcformat:b.jgrid.formatter.date.srcformat;t=this.formatoptions&&this.formatoptions.newformat?this.formatoptions.newformat:b.jgrid.formatter.date.newformat}else s=t=this.datefmt||"Y-m-d";n[this.name]={stype:F,srcfmt:s,newfmt:t}}else n[this.name]={stype:F,srcfmt:"",newfmt:""};if(a.p.grouping&&this.name==z.groupField[0]){var w=this.name;if(typeof this.index!="undefined")w=this.index;p[0]=n[w];A.push(w)}if(!i&&
(this.index==a.p.sortname||this.name==a.p.sortname)){d=this.name;i=true}});if(a.p.treeGrid)b(a).jqGrid("SortTree",d,a.p.sortorder,n[d].stype,n[d].srcfmt);else{var v={eq:function(w){return w.equals},ne:function(w){return w.notEquals},lt:function(w){return w.less},le:function(w){return w.lessOrEquals},gt:function(w){return w.greater},ge:function(w){return w.greaterOrEquals},cn:function(w){return w.contains},nc:function(w,C){return C==="OR"?w.orNot().contains:w.andNot().contains},bw:function(w){return w.startsWith},
bn:function(w,C){return C==="OR"?w.orNot().startsWith:w.andNot().startsWith},en:function(w,C){return C==="OR"?w.orNot().endsWith:w.andNot().endsWith},ew:function(w){return w.endsWith},ni:function(w,C){return C==="OR"?w.orNot().equals:w.andNot().equals},"in":function(w){return w.equals},nu:function(w){return w.isNull},nn:function(w,C){return C==="OR"?w.orNot().isNull:w.andNot().isNull}},u=b.jgrid.from(a.p.data);if(a.p.ignoreCase)u=u.ignoreCase();if(a.p.search===true){var G=a.p.postData.filters;if(G){if(typeof G==
"string")G=b.jgrid.parse(G);e(G)}else try{u=v[a.p.postData.searchOper](u)(a.p.postData.searchField,a.p.postData.searchString,n[a.p.postData.searchField])}catch(R){}}if(a.p.grouping){u.orderBy(A,z.groupOrder[0],p[0].stype,p[0].srcfmt);z.groupDataSorted=true}if(d&&a.p.sortorder&&i)a.p.sortorder.toUpperCase()=="DESC"?u.orderBy(a.p.sortname,"d",n[d].stype,n[d].srcfmt):u.orderBy(a.p.sortname,"a",n[d].stype,n[d].srcfmt);G=u.select();var M=parseInt(a.p.rowNum,10),L=G.length,N=parseInt(a.p.page,10),Y=Math.ceil(L/
M),I={};G=G.slice((N-1)*M,N*M);n=u=null;I[a.p.localReader.total]=Y;I[a.p.localReader.page]=N;I[a.p.localReader.records]=L;I[a.p.localReader.root]=G;G=null;return I}}},aa=function(){a.grid.hDiv.loading=true;if(!a.p.hiddengrid)switch(a.p.loadui){case "enable":b("#load_"+b.jgrid.jqID(a.p.id)).show();break;case "block":b("#lui_"+b.jgrid.jqID(a.p.id)).show();b("#load_"+b.jgrid.jqID(a.p.id)).show()}},pa=function(){a.grid.hDiv.loading=false;switch(a.p.loadui){case "enable":b("#load_"+b.jgrid.jqID(a.p.id)).hide();
...
a.p.rowTotal;var A=a.p.loadComplete,s=b.isFunction(A);s||(A=null);var F=0;e=e||1;if(e>1)if(p.npage!==null){i[p.npage]=e;F=e-1;e=1}else A=function(z){a.p.page++;a.grid.hDiv.loading=false;s&&a.p.loadComplete.call(a,z);ja(e-1)};else p.npage!==null&&delete a.p.postData[p.npage];if(a.p.grouping){b(a).jqGrid("groupingSetup");if(a.p.groupingView.groupDataSorted===true)i[p.sort]=a.p.groupingView.groupField[0]+" "+a.p.groupingView.groupOrder[0]+", "+i[p.sort]}b.extend(a.p.postData,i);var t=!a.p.scroll?1:a.rows.length-
1;if(b.isFunction(a.p.datatype))a.p.datatype.call(a,a.p.postData,"load_"+a.p.id);else{b.isFunction(a.p.beforeRequest)&&a.p.beforeRequest.call(a);n=a.p.datatype.toLowerCase();switch(n){case "json":case "jsonp":case "xml":case "script":b.ajax(b.extend({url:a.p.url,type:a.p.mtype,dataType:n,data:b.isFunction(a.p.serializeGridData)?a.p.serializeGridData.call(a,a.p.postData):a.p.postData,success:function(z){n==="xml"?ga(z,a.grid.bDiv,t,e>1,F):ca(z,a.grid.bDiv,t,e>1,F);A&&A.call(a,z);d&&a.grid.populateVisible();
if(a.p.loadonce||a.p.treeGrid)a.p.datatype="local";pa()},error:function(z,v,u){b.isFunction(a.p.loadError)&&a.p.loadError.call(a,z,v,u);pa()},beforeSend:function(z){aa();b.isFunction(a.p.loadBeforeSend)&&a.p.loadBeforeSend.call(a,z)}},b.jgrid.ajaxOptions,a.p.ajaxGridOptions));break;case "xmlstring":aa();i=b.jgrid.stringToDoc(a.p.datastr);ga(i,a.grid.bDiv);s&&a.p.loadComplete.call(a,i);a.p.datatype="local";a.p.datastr=null;pa();break;case "jsonstring":aa();i=typeof a.p.datastr=="string"?b.jgrid.parse(a.p.datastr):
a.p.datastr;ca(i,a.grid.bDiv);s&&a.p.loadComplete.call(a,i);a.p.datatype="local";a.p.datastr=null;pa();break;case "local":case "clientside":aa();a.p.datatype="local";i=S();ca(i,a.grid.bDiv,t,e>1,F);A&&A.call(a,i);d&&a.grid.populateVisible();pa()}}}};x=function(e,d){var i="",n="<table cellspacing='0' cellpadding='0' border='0' style='table-layout:auto;' class='ui-pg-table'><tbody><tr>",p="",A,s,F,t,z=function(v){var u;if(b.isFunction(a.p.onPaging))u=a.p.onPaging.call(a,v);a.p.selrow=null;if(a.p.multiselect){a.p.selarrrow=
[];b("#cb_"+b.jgrid.jqID(a.p.id),a.grid.hDiv).attr("checked",false)}a.p.savedRow=[];if(u=="stop")return false;return true};e=e.substr(1);d+="_"+e;A="pg_"+e;s=e+"_left";F=e+"_center";t=e+"_right";b("#"+b.jgrid.jqID(e)).append("<div id='"+A+"' class='ui-pager-control' role='group'><table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table' style='width:100%;table-layout:fixed;height:100%;' role='row'><tbody><tr><td id='"+s+"' align='left'></td><td id='"+F+"' align='center' style='white-space:pre;'></td><td id='"+
...
b("#first"+b.jgrid.jqID(d)+", #prev"+b.jgrid.jqID(d)+", #next"+b.jgrid.jqID(d)+", #last"+b.jgrid.jqID(d)).click(function(){var v=K(a.p.page,1),u=K(a.p.lastpage,1),G=false,R=true,M=true,L=true,N=true;if(u===0||u===1)N=L=M=R=false;else if(u>1&&v>=1)if(v===1)M=R=false;else{if(!(v>1&&v<u))if(v===u)N=L=false}else if(u>1&&v===0){N=L=false;v=u-1}if(this.id==="first"+d&&R){a.p.page=1;G=true}if(this.id==="prev"+d&&M){a.p.page=v-1;G=true}if(this.id==="next"+d&&L){a.p.page=v+1;G=true}if(this.id==="last"+d&&
N){a.p.page=u;G=true}if(G){if(!z(this.id))return false;ja()}return false})}a.p.pginput===true&&b("input.ui-pg-input","#"+A).keypress(function(v){if((v.charCode?v.charCode:v.keyCode?v.keyCode:0)==13){a.p.page=b(this).val()>0?b(this).val():a.p.page;if(!z("user"))return false;ja();return false}return this})};var Ca=function(e,d,i,n){if(a.p.colModel[d].sortable)if(!(a.p.savedRow.length>0)){if(!i){if(a.p.lastsort==d)if(a.p.sortorder=="asc")a.p.sortorder="desc";else{if(a.p.sortorder=="desc")a.p.sortorder=
...
d){b("tr th:eq("+a.p.lastsort+") span.s-ico",i).hide();b("tr th:eq("+d+") span.s-ico",i).show()}e=e.substring(5);a.p.sortname=a.p.colModel[d].index||e;i=a.p.sortorder;if(b.isFunction(a.p.onSortCol))if(a.p.onSortCol.call(a,e,d,i)=="stop"){a.p.lastsort=d;return}if(a.p.datatype=="local")a.p.deselectAfterSort&&b(a).jqGrid("resetSelection");else{a.p.selrow=null;a.p.multiselect&&b("#cb_"+b.jgrid.jqID(a.p.id),a.grid.hDiv).attr("checked",false);a.p.selarrrow=[];a.p.savedRow=[]}if(a.p.scroll){i=a.grid.bDiv.scrollLeft;
W(a.grid.bDiv,true,false);a.grid.hDiv.scrollLeft=i}a.p.subGrid&&a.p.datatype=="local"&&b("td.sgexpanded","#"+b.jgrid.jqID(a.p.id)).each(function(){b(this).trigger("click")});ja();a.p.lastsort=d;if(a.p.sortname!=e&&d)a.p.lastsort=d}},Fa=function(e){var d,i={},n=E?0:a.p.cellLayout;for(d=i[0]=i[1]=i[2]=0;d<=e;d++)if(a.p.colModel[d].hidden===false)i[0]+=a.p.colModel[d].width+n;if(a.p.direction=="rtl")i[0]=a.p.width-i[0];i[0]-=a.grid.bDiv.scrollLeft;if(b(a.grid.cDiv).is(":visible"))i[1]+=b(a.grid.cDiv).height()+
parseInt(b(a.grid.cDiv).css("padding-top"),10)+parseInt(b(a.grid.cDiv).css("padding-bottom"),10);if(a.p.toolbar[0]===true&&(a.p.toolbar[1]=="top"||a.p.toolbar[1]=="both"))i[1]+=b(a.grid.uDiv).height()+parseInt(b(a.grid.uDiv).css("border-top-width"),10)+parseInt(b(a.grid.uDiv).css("border-bottom-width"),10);if(a.p.toppager)i[1]+=b(a.grid.topDiv).height()+parseInt(b(a.grid.topDiv).css("border-bottom-width"),10);i[2]+=b(a.grid.bDiv).height()+b(a.grid.hDiv).height();return i};this.p.id=this.id;if(b.inArray(a.p.multikey,
["shiftKey","altKey","ctrlKey"])==-1)a.p.multikey=false;a.p.keyIndex=false;for(k=0;k<a.p.colModel.length;k++){a.p.colModel[k]=b.extend(true,{},a.p.cmTemplate,a.p.colModel[k].template||{},a.p.colModel[k]);if(a.p.keyIndex===false&&a.p.colModel[k].key===true)a.p.keyIndex=k}a.p.sortorder=a.p.sortorder.toLowerCase();if(a.p.grouping===true){a.p.scroll=false;a.p.rownumbers=false;a.p.subGrid=false;a.p.treeGrid=false;a.p.gridview=true}if(this.p.treeGrid===true){try{b(this).jqGrid("setTreeGrid")}catch(Ja){}if(a.p.datatype!=
"local")a.p.localReader={id:"_id_"}}if(this.p.subGrid)try{b(a).jqGrid("setSubGrid")}catch(Ka){}if(this.p.multiselect){this.p.colNames.unshift("<input role='checkbox' id='cb_"+this.p.id+"' class='cbox' type='checkbox'/>");this.p.colModel.unshift({name:"cb",width:E?a.p.multiselectWidth+a.p.cellLayout:a.p.multiselectWidth,sortable:false,resizable:false,hidedlg:true,search:false,align:"center",fixed:true})}if(this.p.rownumbers){this.p.colNames.unshift("");this.p.colModel.unshift({name:"rn",width:a.p.rownumWidth,
...
cell:"cell"}},a.p.jsonReader);a.p.localReader=b.extend(true,{root:"rows",page:"page",total:"total",records:"records",repeatitems:false,cell:"cell",id:"id",userdata:"userdata",subgrid:{root:"rows",repeatitems:true,cell:"cell"}},a.p.localReader);if(a.p.scroll){a.p.pgbuttons=false;a.p.pginput=false;a.p.rowList=[]}a.p.data.length&&U();var ba="<thead><tr class='ui-jqgrid-labels' role='rowheader'>",Da,ma,sa,qa,ta,X,P,na;ma=na="";if(a.p.shrinkToFit===true&&a.p.forceFit===true)for(k=a.p.colModel.length-1;k>=
0;k--)if(!a.p.colModel[k].hidden){a.p.colModel[k].resizable=false;break}if(a.p.viewsortcols[1]=="horizontal"){na=" ui-i-asc";ma=" ui-i-desc"}Da=y?"class='ui-th-div-ie'":"";na="<span class='s-ico' style='display:none'><span sort='asc' class='ui-grid-ico-sort ui-icon-asc"+na+" ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-"+l+"'></span>";na+="<span sort='desc' class='ui-grid-ico-sort ui-icon-desc"+ma+" ui-state-disabled ui-icon ui-icon-triangle-1-s ui-sort-"+l+"'></span></span>";for(k=0;k<
this.p.colNames.length;k++){ma=a.p.headertitles?' title="'+b.jgrid.stripHtml(a.p.colNames[k])+'"':"";ba+="<th id='"+a.p.id+"_"+a.p.colModel[k].name+"' role='columnheader' class='ui-state-default ui-th-column ui-th-"+l+"'"+ma+">";ma=a.p.colModel[k].index||a.p.colModel[k].name;ba+="<div id='jqgh_"+a.p.id+"_"+a.p.colModel[k].name+"' "+Da+">"+a.p.colNames[k];a.p.colModel[k].width=a.p.colModel[k].width?parseInt(a.p.colModel[k].width,10):150;if(typeof a.p.colModel[k].title!=="boolean")a.p.colModel[k].title=
true;if(ma==a.p.sortname)a.p.lastsort=k;ba+=na+"</div></th>"}ba+="</tr></thead>";na=null;b(this).append(ba);b("thead tr:first th",this).hover(function(){b(this).addClass("ui-state-hover")},function(){b(this).removeClass("ui-state-hover")});if(this.p.multiselect){var za=[],ua;b("#cb_"+b.jgrid.jqID(a.p.id),this).bind("click",function(){a.p.selarrrow=[];if(this.checked){b(a.rows).each(function(e){if(e>0)if(!b(this).hasClass("subgrid")&&!b(this).hasClass("jqgroup")&&!b(this).hasClass("ui-state-disabled")){b("#jqg_"+
...
null;ua=false}if(b.isFunction(a.p.onSelectAll))a.p.onSelectAll.call(a,ua?a.p.selarrrow:za,ua)})}if(a.p.autowidth===true){ba=b(Q).innerWidth();a.p.width=ba>0?ba:"nw"}(function(){var e=0,d=E?0:a.p.cellLayout,i=0,n,p=a.p.scrollOffset,A,s=false,F,t=0,z=0,v;b.each(a.p.colModel,function(){if(typeof this.hidden==="undefined")this.hidden=false;this.widthOrg=A=K(this.width,0);if(this.hidden===false){e+=A+d;if(this.fixed)t+=A+d;else i++;z++}});if(isNaN(a.p.width))a.p.width=g.width=e;else g.width=a.p.width;
a.p.tblwidth=e;if(a.p.shrinkToFit===false&&a.p.forceFit===true)a.p.forceFit=false;if(a.p.shrinkToFit===true&&i>0){F=g.width-d*i-t;if(!isNaN(a.p.height)){F-=p;s=true}e=0;b.each(a.p.colModel,function(u){if(this.hidden===false&&!this.fixed){this.width=A=Math.round(F*this.width/(a.p.tblwidth-d*i-t));e+=A;n=u}});v=0;if(s){if(g.width-t-(e+d*i)!==p)v=g.width-t-(e+d*i)-p}else if(!s&&Math.abs(g.width-t-(e+d*i))!==1)v=g.width-t-(e+d*i);a.p.colModel[n].width+=v;a.p.tblwidth=e+v+d*i+t;if(a.p.tblwidth>a.p.width){a.p.colModel[n].width-=
a.p.tblwidth-parseInt(a.p.width,10);a.p.tblwidth=a.p.width}}})();b(Q).css("width",g.width+"px").append("<div class='ui-jqgrid-resize-mark' id='rs_m"+a.p.id+"'>&#160;</div>");b(r).css("width",g.width+"px");ba=b("thead:first",a).get(0);var va="";if(a.p.footerrow)va+="<table role='grid' style='width:"+a.p.tblwidth+"px' class='ui-jqgrid-ftable' cellspacing='0' cellpadding='0' border='0'><tbody><tr role='row' class='ui-widget-content footrow footrow-"+l+"'>";r=b("tr:first",ba);var wa="<tr class='jqgfirstrow' role='row' style='height:auto'>";
a.p.disableClick=false;b("th",r).each(function(e){sa=a.p.colModel[e].width;if(typeof a.p.colModel[e].resizable==="undefined")a.p.colModel[e].resizable=true;if(a.p.colModel[e].resizable){qa=document.createElement("span");b(qa).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-"+l);b.browser.opera||b(qa).css("cursor","col-resize");b(this).addClass(a.p.resizeclass)}else qa="";b(this).css("width",sa+"px").prepend(qa);var d="";if(a.p.colModel[e].hidden){b(this).css("display","none");d="display:none;"}wa+=
...
this).show();b("div span.ui-icon-"+a.p.sortorder,this).removeClass("ui-state-disabled")}if(a.p.footerrow)va+="<td role='gridcell' "+O(e,0,"",null,"",false)+">&#160;</td>"}).mousedown(function(e){if(b(e.target).closest("th>span.ui-jqgrid-resize").length==1){var d=b.jgrid.getCellIndex(this);if(a.p.forceFit===true){var i=a.p,n=d,p;for(p=d+1;p<a.p.colModel.length;p++)if(a.p.colModel[p].hidden!==true){n=p;break}i.nv=n-d}g.dragStart(d,e,Fa(d));return false}}).click(function(e){if(a.p.disableClick)return a.p.disableClick=
...
wa=null;r=b("<table class='ui-jqgrid-htable' style='width:"+a.p.tblwidth+"px' role='grid' aria-labelledby='gbox_"+this.id+"' cellspacing='0' cellpadding='0' border='0'></table>").append(ba);var da=a.p.caption&&a.p.hiddengrid===true?true:false;k=b("<div class='ui-jqgrid-hbox"+(l=="rtl"?"-rtl":"")+"'></div>");ba=null;g.hDiv=document.createElement("div");b(g.hDiv).css({width:g.width+"px"}).addClass("ui-state-default ui-jqgrid-hdiv").append(k);b(k).append(r);r=null;da&&b(g.hDiv).hide();if(a.p.pager){if(typeof a.p.pager==
"string"){if(a.p.pager.substr(0,1)!="#")a.p.pager="#"+a.p.pager}else a.p.pager="#"+b(a.p.pager).attr("id");b(a.p.pager).css({width:g.width+"px"}).appendTo(Q).addClass("ui-state-default ui-jqgrid-pager ui-corner-bottom");da&&b(a.p.pager).hide();x(a.p.pager,"")}a.p.cellEdit===false&&a.p.hoverrows===true&&b(a).bind("mouseover",function(e){P=b(e.target).closest("tr.jqgrow");b(P).attr("class")!=="subgrid"&&b(P).addClass("ui-state-hover");return false}).bind("mouseout",function(e){P=b(e.target).closest("tr.jqgrow");
b(P).removeClass("ui-state-hover");return false});var ka,la;b(a).before(g.hDiv).click(function(e){X=e.target;P=b(X,a.rows).closest("tr.jqgrow");if(b(P).length===0||P[0].className.indexOf("ui-state-disabled")>-1)return this;var d=b(X).hasClass("cbox"),i=true;if(b.isFunction(a.p.beforeSelectRow))i=a.p.beforeSelectRow.call(a,P[0].id,e);if(X.tagName=="A"||(X.tagName=="INPUT"||X.tagName=="TEXTAREA"||X.tagName=="OPTION"||X.tagName=="SELECT")&&!d)return this;if(i===true){if(a.p.cellEdit===true)if(a.p.multiselect&&
d)b(a).jqGrid("setSelection",P[0].id,true);else{ka=P[0].rowIndex;la=b.jgrid.getCellIndex(X);try{b(a).jqGrid("editCell",ka,la,true)}catch(n){}}else if(a.p.multikey)if(e[a.p.multikey])b(a).jqGrid("setSelection",P[0].id,true);else{if(a.p.multiselect&&d){d=b("#jqg_"+b.jgrid.jqID(a.p.id)+"_"+P[0].id).attr("checked");b("#jqg_"+b.jgrid.jqID(a.p.id)+"_"+P[0].id).attr("checked",!d)}}else{if(a.p.multiselect&&a.p.multiboxonly)if(!d){b(a.p.selarrrow).each(function(p,A){var s=a.rows.namedItem(A);b(s).removeClass("ui-state-highlight");
b("#jqg_"+b.jgrid.jqID(a.p.id)+"_"+b.jgrid.jqID(A)).attr("checked",false)});a.p.selarrrow=[];b("#cb_"+b.jgrid.jqID(a.p.id),a.grid.hDiv).attr("checked",false)}b(a).jqGrid("setSelection",P[0].id,true)}if(b.isFunction(a.p.onCellSelect)){ka=P[0].id;la=b.jgrid.getCellIndex(X);a.p.onCellSelect.call(a,ka,la,b(X).html(),e)}}return this}).bind("reloadGrid",function(e,d){if(a.p.treeGrid===true)a.p.datatype=a.p.treedatatype;d&&d.current&&a.grid.selectionPreserver(a);if(a.p.datatype=="local"){b(a).jqGrid("resetSelection");
a.p.data.length&&U()}else if(!a.p.treeGrid){a.p.selrow=null;if(a.p.multiselect){a.p.selarrrow=[];b("#cb_"+b.jgrid.jqID(a.p.id),a.grid.hDiv).attr("checked",false)}a.p.savedRow=[]}a.p.scroll&&W(a.grid.bDiv,true,false);if(d&&d.page){var i=d.page;if(i>a.p.lastpage)i=a.p.lastpage;if(i<1)i=1;a.p.page=i;a.grid.bDiv.scrollTop=a.grid.prevRowHeight?(i-1)*a.grid.prevRowHeight*a.p.rowNum:0}if(a.grid.prevRowHeight&&a.p.scroll){delete a.p.lastpage;a.grid.populateVisible()}else a.grid.populate();return false});
b.isFunction(this.p.ondblClickRow)&&b(this).dblclick(function(e){X=e.target;P=b(X,a.rows).closest("tr.jqgrow");if(b(P).length===0)return false;ka=P[0].rowIndex;la=b.jgrid.getCellIndex(X);a.p.ondblClickRow.call(a,b(P).attr("id"),ka,la,e);return false});b.isFunction(this.p.onRightClickRow)&&b(this).bind("contextmenu",function(e){X=e.target;P=b(X,a.rows).closest("tr.jqgrow");if(b(P).length===0)return false;a.p.multiselect||b(a).jqGrid("setSelection",P[0].id,true);ka=P[0].rowIndex;la=b.jgrid.getCellIndex(X);
a.p.onRightClickRow.call(a,b(P).attr("id"),ka,la,e);return false});g.bDiv=document.createElement("div");if(y)if(String(a.p.height).toLowerCase()==="auto")a.p.height="100%";b(g.bDiv).append(b('<div style="position:relative;'+(y&&b.browser.version<8?"height:0.01%;":"")+'"></div>').append("<div></div>").append(this)).addClass("ui-jqgrid-bdiv").css({height:a.p.height+(isNaN(a.p.height)?"":"px"),width:g.width+"px"}).scroll(g.scrollGrid);b("table:first",g.bDiv).css({width:a.p.tblwidth+"px"});if(y){b("tbody",
this).size()==2&&b("tbody:gt(0)",this).remove();a.p.multikey&&b(g.bDiv).bind("selectstart",function(){return false})}else a.p.multikey&&b(g.bDiv).bind("mousedown",function(){return false});da&&b(g.bDiv).hide();g.cDiv=document.createElement("div");var Aa=a.p.hidegrid===true?b("<a role='link' href='javascript:void(0)'/>").addClass("ui-jqgrid-titlebar-close HeaderButton").hover(function(){Aa.addClass("ui-state-hover")},function(){Aa.removeClass("ui-state-hover")}).append("<span class='ui-icon ui-icon-circle-triangle-n'></span>").css(l==
...
a.p.onHeaderClick.call(a,a.p.gridstate,e)}});return false});if(da){a.p.datatype="local";b(".ui-jqgrid-titlebar-close",g.cDiv).trigger("click")}}}else b(g.cDiv).hide();b(g.hDiv).after(g.bDiv).mousemove(function(e){if(g.resizing){g.dragMove(e);return false}});b(".ui-jqgrid-labels",g.hDiv).bind("selectstart",function(){return false});b(document).mouseup(function(){if(g.resizing){g.dragEnd();return false}return true});a.formatCol=O;a.sortData=Ca;a.updatepager=function(e,d){var i,n,p,A,s,F,t,z="",v=a.p.pager?
"_"+b.jgrid.jqID(a.p.pager.substr(1)):"",u=a.p.toppager?"_"+a.p.toppager.substr(1):"";p=parseInt(a.p.page,10)-1;if(p<0)p=0;p*=parseInt(a.p.rowNum,10);s=p+a.p.reccount;if(a.p.scroll){i=b("tbody:first > tr:gt(0)",a.grid.bDiv);p=s-i.length;a.p.reccount=i.length;if(n=i.outerHeight()||a.grid.prevRowHeight){i=p*n;n*=parseInt(a.p.records,10);b(">div:first",a.grid.bDiv).css({height:n}).children("div:first").css({height:i,display:i?"":"none"})}a.grid.bDiv.scrollLeft=a.grid.hDiv.scrollLeft}z=a.p.pager?a.p.pager:
"";z+=a.p.toppager?z?","+a.p.toppager:a.p.toppager:"";if(z){t=b.jgrid.formatter.integer||{};i=K(a.p.page);n=K(a.p.lastpage);b(".selbox",z).attr("disabled",false);if(a.p.pginput===true){b(".ui-pg-input",z).val(a.p.page);A=a.p.toppager?"#sp_1"+v+",#sp_1"+u:"#sp_1"+v;b(A).html(b.fmatter?b.fmatter.util.NumberFormat(a.p.lastpage,t):a.p.lastpage)}if(a.p.viewrecords)if(a.p.reccount===0)b(".ui-paging-info",z).html(a.p.emptyrecords);else{A=p+1;F=a.p.records;if(b.fmatter){A=b.fmatter.util.NumberFormat(A,t);
s=b.fmatter.util.NumberFormat(s,t);F=b.fmatter.util.NumberFormat(F,t)}b(".ui-paging-info",z).html(b.jgrid.format(a.p.recordtext,A,s,F))}if(a.p.pgbuttons===true){if(i<=0)i=n=0;if(i==1||i===0){b("#first"+v+", #prev"+v).addClass("ui-state-disabled").removeClass("ui-state-hover");a.p.toppager&&b("#first_t"+u+", #prev_t"+u).addClass("ui-state-disabled").removeClass("ui-state-hover")}else{b("#first"+v+", #prev"+v).removeClass("ui-state-disabled");a.p.toppager&&b("#first_t"+u+", #prev_t"+u).removeClass("ui-state-disabled")}if(i==
n||i===0){b("#next"+v+", #last"+v).addClass("ui-state-disabled").removeClass("ui-state-hover");a.p.toppager&&b("#next_t"+u+", #last_t"+u).addClass("ui-state-disabled").removeClass("ui-state-hover")}else{b("#next"+v+", #last"+v).removeClass("ui-state-disabled");a.p.toppager&&b("#next_t"+u+", #last_t"+u).removeClass("ui-state-disabled")}}}e===true&&a.p.rownumbers===true&&b("td.jqgrid-rownum",a.rows).each(function(G){b(this).html(p+1+G)});d&&a.p.jqgdnd&&b(a).jqGrid("gridDnD","updateDnD");b.isFunction(a.p.gridComplete)&&
a.p.gridComplete.call(a)};a.refreshIndex=U;a.formatter=function(e,d,i,n,p){return o(e,d,i,n,p)};b.extend(g,{populate:ja,emptyRows:W});this.grid=g;a.addXmlData=function(e){ga(e,a.grid.bDiv)};a.addJSONData=function(e){ca(e,a.grid.bDiv)};this.grid.cols=this.rows[0].cells;ja();a.p.hiddengrid=false;b(window).unload(function(){a=null})}}}})};b.jgrid.extend({getGridParam:function(f){var j=this[0];if(j&&j.grid)return f?typeof j.p[f]!="undefined"?j.p[f]:null:j.p},setGridParam:function(f){return this.each(function(){this.grid&&
typeof f==="object"&&b.extend(true,this.p,f)})},getDataIDs:function(){var f=[],j=0,h,c=0;this.each(function(){if((h=this.rows.length)&&h>0)for(;j<h;){if(b(this.rows[j]).hasClass("jqgrow")){f[c]=this.rows[j].id;c++}j++}});return f},setSelection:function(f,j){return this.each(function(){function h(a){var r=b(c.grid.bDiv)[0].clientHeight,x=b(c.grid.bDiv)[0].scrollTop,y=c.rows[a].offsetTop;a=c.rows[a].clientHeight;if(y+a>=r+x)b(c.grid.bDiv)[0].scrollTop=y-(r+x)+a+x;else if(y<r+x)if(y<x)b(c.grid.bDiv)[0].scrollTop=
...
getRowData:function(f){var j={},h,c=false,g,k=0;this.each(function(){var l=this,a,r;if(typeof f=="undefined"){c=true;h=[];g=l.rows.length}else{r=l.rows.namedItem(f);if(!r)return j;g=2}for(;k<g;){if(c)r=l.rows[k];if(b(r).hasClass("jqgrow")){b("td",r).each(function(x){a=l.p.colModel[x].name;if(a!=="cb"&&a!=="subgrid"&&a!=="rn")if(l.p.treeGrid===true&&a==l.p.ExpandColumn)j[a]=b.jgrid.htmlDecode(b("span:first",this).html());else try{j[a]=b.unformat(this,{rowId:r.id,colModel:l.p.colModel[x]},x)}catch(y){j[a]=
...
1);this.refreshIndex()}}if(this.p.altRows===true&&j){var k=this.p.altclass;b(this.rows).each(function(l){l%2==1?b(this).addClass(k):b(this).removeClass(k)})}});return j},setRowData:function(f,j,h){var c,g=true,k;this.each(function(){if(!this.grid)return false;var l=this,a,r,x=typeof h,y={};r=l.rows.namedItem(f);if(!r)return false;if(j)try{b(this.p.colModel).each(function(O){c=this.name;if(j[c]!==undefined){y[c]=this.formatter&&typeof this.formatter==="string"&&this.formatter=="date"?b.unformat.date(j[c],
this):j[c];a=l.formatter(f,j[c],O,j,"edit");k=this.title?{title:b.jgrid.stripHtml(a)}:{};l.p.treeGrid===true&&c==l.p.ExpandColumn?b("td:eq("+O+") > span:first",r).html(a).attr(k):b("td:eq("+O+")",r).html(a).attr(k)}});if(l.p.datatype=="local"){var E=l.p._index[f];if(l.p.treeGrid)for(var Q in l.p.treeReader)y.hasOwnProperty(l.p.treeReader[Q])&&delete y[l.p.treeReader[Q]];if(typeof E!="undefined")l.p.data[E]=b.extend(true,l.p.data[E],y);y=null}}catch(K){g=false}if(g)if(x==="string")b(r).addClass(h);
else x==="object"&&b(r).css(h)});return g},addRowData:function(f,j,h,c){h||(h="last");var g=false,k,l,a,r,x,y,E,Q,K="",O,m,o,q,B;if(j){if(b.isArray(j)){O=true;h="last";m=f}else{j=[j];O=false}this.each(function(){var T=j.length;x=this.p.rownumbers===true?1:0;a=this.p.multiselect===true?1:0;r=this.p.subGrid===true?1:0;if(!O)if(typeof f!="undefined")f+="";else{f=b.jgrid.randId();if(this.p.keyIndex!==false){m=this.p.colModel[this.p.keyIndex+a+r+x].name;if(typeof j[0][m]!="undefined")f=j[0][m]}}o=this.p.altclass;
for(var J=0,D="",W={},U=b.isFunction(this.p.afterInsertRow)?true:false;J<T;){q=j[J];l="";if(O){try{f=q[m]}catch(ga){f=b.jgrid.randId()}D=this.p.altRows===true?(this.rows.length-1)%2===0?o:"":""}if(x){K=this.formatCol(0,1,"",null,f,true);l+='<td role="gridcell" aria-describedby="'+this.p.id+'_rn" class="ui-state-default jqgrid-rownum" '+K+">0</td>"}if(a){Q='<input role="checkbox" type="checkbox" id="jqg_'+this.p.id+"_"+f+'" class="cbox"/>';K=this.formatCol(x,1,"",null,f,true);l+='<td role="gridcell" aria-describedby="'+
this.p.id+'_cb" '+K+">"+Q+"</td>"}if(r)l+=b(this).jqGrid("addSubGridCell",a+x,1);for(E=a+r+x;E<this.p.colModel.length;E++){B=this.p.colModel[E];k=B.name;W[k]=B.formatter&&typeof B.formatter==="string"&&B.formatter=="date"?b.unformat.date(q[k],B):q[k];Q=this.formatter(f,b.jgrid.getAccessor(q,k),E,q,"edit");K=this.formatCol(E,1,Q,f,q,true);l+='<td role="gridcell" aria-describedby="'+this.p.id+"_"+k+'" '+K+">"+Q+"</td>"}l='<tr id="'+f+'" role="row" tabindex="-1" class="ui-widget-content jqgrow ui-row-'+
this.p.direction+" "+D+'">'+l+"</tr>";if(this.rows.length===0)b("table:first",this.grid.bDiv).append(l);else switch(h){case "last":b(this.rows[this.rows.length-1]).after(l);y=this.rows.length-1;break;case "first":b(this.rows[0]).after(l);y=1;break;case "after":if(y=this.rows.namedItem(c))b(this.rows[y.rowIndex+1]).hasClass("ui-subgrid")?b(this.rows[y.rowIndex+1]).after(l):b(y).after(l);y++;break;case "before":if(y=this.rows.namedItem(c)){b(y).before(l);y=y.rowIndex}y--}this.p.subGrid===true&&b(this).jqGrid("addSubGrid",
a+x,y);this.p.records++;this.p.reccount++;U&&this.p.afterInsertRow.call(this,f,q,q);J++;if(this.p.datatype=="local"){W[this.p.localReader.id]=f;this.p._index[f]=this.p.data.length;this.p.data.push(W);W={}}}if(this.p.altRows===true&&!O)if(h=="last")(this.rows.length-1)%2==1&&b(this.rows[this.rows.length-1]).addClass(o);else b(this.rows).each(function(ca){ca%2==1?b(this).addClass(o):b(this).removeClass(o)});this.updatepager(true,true);g=true})}return g},footerData:function(f,j,h){function c(r){for(var x in r)if(r.hasOwnProperty(x))return false;
return true}var g,k=false,l={},a;if(typeof f=="undefined")f="get";if(typeof h!="boolean")h=true;f=f.toLowerCase();this.each(function(){var r=this,x;if(!r.grid||!r.p.footerrow)return false;if(f=="set")if(c(j))return false;k=true;b(this.p.colModel).each(function(y){g=this.name;if(f=="set"){if(j[g]!==undefined){x=h?r.formatter("",j[g],y,j,"edit"):j[g];a=this.title?{title:b.jgrid.stripHtml(x)}:{};b("tr.footrow td:eq("+y+")",r.grid.sDiv).html(x).attr(a);k=true}}else if(f=="get")l[g]=b("tr.footrow td:eq("+
y+")",r.grid.sDiv).html()})});return f=="get"?l:k},showHideCol:function(f,j){return this.each(function(){var h=this,c=false,g=b.browser.webkit||b.browser.safari?0:h.p.cellLayout,k;if(h.grid){if(typeof f==="string")f=[f];j=j!="none"?"":"none";var l=j===""?true:false;b(this.p.colModel).each(function(a){if(b.inArray(this.name,f)!==-1&&this.hidden===l){b("tr",h.grid.hDiv).each(function(){b(this).children("th:eq("+a+")").css("display",j)});b(h.rows).each(function(){b(this).children("td:eq("+a+")").css("display",
...
f,"")})},remapColumns:function(f,j,h){function c(l){var a;a=l.length?b.makeArray(l):b.extend({},l);b.each(f,function(r){l[r]=a[this]})}function g(l,a){b(">tr"+(a||""),l).each(function(){var r=this,x=b.makeArray(r.cells);b.each(f,function(){var y=x[this];y&&r.appendChild(y)})})}var k=this.get(0);c(k.p.colModel);c(k.p.colNames);c(k.grid.headers);g(b("thead:first",k.grid.hDiv),h&&":not(.ui-jqgrid-labels)");j&&g(b("#"+b.jgrid.jqID(k.p.id)+" tbody:first"),".jqgfirstrow, tr.jqgrow, tr.jqfoot");k.p.footerrow&&
g(b("tbody:first",k.grid.sDiv));if(k.p.remapColumns)if(k.p.remapColumns.length)c(k.p.remapColumns);else k.p.remapColumns=b.makeArray(f);k.p.lastsort=b.inArray(k.p.lastsort,f);if(k.p.treeGrid)k.p.expColInd=b.inArray(k.p.expColInd,f)},setGridWidth:function(f,j){return this.each(function(){if(this.grid){var h=this,c,g=0,k=b.browser.webkit||b.browser.safari?0:h.p.cellLayout,l,a=0,r=false,x=h.p.scrollOffset,y,E=0,Q=0,K;if(typeof j!="boolean")j=h.p.shrinkToFit;if(!isNaN(f)){f=parseInt(f,10);h.grid.width=
...
false;if(j===true){b.each(h.p.colModel,function(){if(this.hidden===false){c=this.widthOrg?this.widthOrg:parseInt(this.width,10);g+=c+k;if(this.fixed)E+=c+k;else a++;Q++}});if(a===0)return;h.p.tblwidth=g;y=f-k*a-E;if(!isNaN(h.p.height))if(b(h.grid.bDiv)[0].clientHeight<b(h.grid.bDiv)[0].scrollHeight||h.rows.length===1){r=true;y-=x}g=0;var O=h.grid.cols.length>0;b.each(h.p.colModel,function(m){if(this.hidden===false&&!this.fixed){c=this.widthOrg?this.widthOrg:parseInt(this.width,10);c=Math.round(y*
c/(h.p.tblwidth-k*a-E));if(!(c<0)){this.width=c;g+=c;h.grid.headers[m].width=c;h.grid.headers[m].el.style.width=c+"px";if(h.p.footerrow)h.grid.footers[m].style.width=c+"px";if(O)h.grid.cols[m].style.width=c+"px";l=m}}});K=0;if(r){if(f-E-(g+k*a)!==x)K=f-E-(g+k*a)-x}else if(Math.abs(f-E-(g+k*a))!==1)K=f-E-(g+k*a);h.p.colModel[l].width+=K;h.p.tblwidth=g+K+k*a+E;if(h.p.tblwidth>f){r=h.p.tblwidth-parseInt(f,10);h.p.tblwidth=f;c=h.p.colModel[l].width-=r}else c=h.p.colModel[l].width;h.grid.headers[l].width=
c;h.grid.headers[l].el.style.width=c+"px";if(O)h.grid.cols[l].style.width=c+"px";if(h.p.footerrow)h.grid.footers[l].style.width=c+"px"}if(h.p.tblwidth){b("table:first",h.grid.bDiv).css("width",h.p.tblwidth+"px");b("table:first",h.grid.hDiv).css("width",h.p.tblwidth+"px");h.grid.hDiv.scrollLeft=h.grid.bDiv.scrollLeft;h.p.footerrow&&b("table:first",h.grid.sDiv).css("width",h.p.tblwidth+"px")}}}})},setGridHeight:function(f){return this.each(function(){if(this.grid){b(this.grid.bDiv).css({height:f+(isNaN(f)?
...
j){c=l;return false}});else c=parseInt(j,10);if(c>=0){var g=this.rows.namedItem(f);if(g)try{h=b.unformat(b("td:eq("+c+")",g),{rowId:g.id,colModel:this.p.colModel[c]},c)}catch(k){h=b.jgrid.htmlDecode(b("td:eq("+c+")",g).html())}}}});return h},getCol:function(f,j,h){var c=[],g,k=0,l=0,a=0,r;j=typeof j!="boolean"?false:j;if(typeof h=="undefined")h=false;this.each(function(){var x=-1;if(this.grid){if(isNaN(f))b(this.p.colModel).each(function(K){if(this.name===f){x=K;return false}});else x=parseInt(f,
10);if(x>=0){var y=this.rows.length,E=0;if(y&&y>0){for(;E<y;){if(b(this.rows[E]).hasClass("jqgrow")){try{g=b.unformat(b(this.rows[E].cells[x]),{rowId:this.rows[E].id,colModel:this.p.colModel[x]},x)}catch(Q){g=b.jgrid.htmlDecode(this.rows[E].cells[x].innerHTML)}if(h){r=parseFloat(g);k+=r;l=Math.min(l,r);a=Math.max(l,r)}else j?c.push({id:this.rows[E].id,value:g}):c.push(g)}E++}if(h)switch(h.toLowerCase()){case "sum":c=k;break;case "avg":c=k/y;break;case "count":c=y;break;case "min":c=l;break;case "max":c=
...
0;this.p.reccount=0;this.p.data=[];this.p_index={};this.updatepager(true,false)}})},getInd:function(f,j){var h=false,c;this.each(function(){if(c=this.rows.namedItem(f))h=j===true?c:c.rowIndex});return h},bindKeys:function(f){var j=b.extend({onEnter:null,onSpace:null,onLeftKey:null,onRightKey:null,scrollingRows:true},f||{});return this.each(function(){var h=this;b("body").is("[role]")||b("body").attr("role","application");h.p.scrollrows=j.scrollingRows;b(h).keydown(function(c){var g=b(h).find("tr[tabindex=0]")[0],
k,l,a,r=h.p.treeReader.expanded_field;if(g){a=h.p._index[g.id];if(c.keyCode===37||c.keyCode===38||c.keyCode===39||c.keyCode===40){if(c.keyCode===38){l=g.previousSibling;k="";if(l)if(b(l).is(":hidden"))for(;l;){l=l.previousSibling;if(!b(l).is(":hidden")&&b(l).hasClass("jqgrow")){k=l.id;break}}else k=l.id;b(h).jqGrid("setSelection",k)}if(c.keyCode===40){l=g.nextSibling;k="";if(l)if(b(l).is(":hidden"))for(;l;){l=l.nextSibling;if(!b(l).is(":hidden")&&b(l).hasClass("jqgrow")){k=l.id;break}}else k=l.id;
b(h).jqGrid("setSelection",k)}if(c.keyCode===37){h.p.treeGrid&&h.p.data[a][r]&&b(g).find("div.treeclick").trigger("click");b.isFunction(j.onLeftKey)&&j.onLeftKey.call(h,h.p.selrow)}if(c.keyCode===39){h.p.treeGrid&&!h.p.data[a][r]&&b(g).find("div.treeclick").trigger("click");b.isFunction(j.onRightKey)&&j.onRightKey.call(h,h.p.selrow)}return false}else if(c.keyCode===13){b.isFunction(j.onEnter)&&j.onEnter.call(h,h.p.selrow);return false}else if(c.keyCode===32){b.isFunction(j.onSpace)&&j.onSpace.call(h,
h.p.selrow);return false}}})})},unbindKeys:function(){return this.each(function(){b(this).unbind("keydown")})},getLocalRow:function(f){var j=false,h;this.each(function(){if(typeof f!=="undefined"){h=this.p._index[f];if(h>=0)j=this.p.data[h]}});return j}})})(jQuery);
...
sopt:null,stringResult:undefined,onClose:null,onSearch:null,onReset:null,toTop:true,overlay:10,columns:[],tmplNames:null,tmplFilters:null,tmplLabel:" Template: ",showOnLoad:false,layer:null},a.jgrid.search,d||{});return this.each(function(){function b(){if(a.isFunction(d.beforeShowSearch)){E=d.beforeShowSearch(a("#"+n));if(typeof E==="undefined")E=true}if(E){a.jgrid.viewModal("#"+D.themodal,{gbox:"#gbox_"+n,jqm:d.jqModal,modal:d.modal,overlay:d.overlay,toTop:d.toTop});a.isFunction(d.afterShowSearch)&&
d.afterShowSearch(a("#"+n))}}var c=this;if(c.grid){var n="fbox_"+c.p.id,E=true,D={themodal:"searchmod"+n,modalhead:"searchhd"+n,modalcontent:"searchcnt"+n,scrollelm:n},F=c.p.postData[d.sFilter];if(typeof F==="string")F=a.jgrid.parse(F);d.recreateFilter===true&&a("#"+D.themodal).remove();if(a("#"+D.themodal).html()!==null)b();else{var s=a("<span><div id='"+n+"' class='searchFilter' style='overflow:auto'></div></span>").insertBefore("#gview_"+c.p.id);if(a.isFunction(d.onInitializeSearch))d.onInitializeSearch(a("#"+
n));var q=a.extend([],c.p.colModel),u="<a href='javascript:void(0)' id='"+n+"_search' class='fm-button ui-state-default ui-corner-all fm-button-icon-right ui-reset'><span class='ui-icon ui-icon-search'></span>"+d.Find+"</a>",p="<a href='javascript:void(0)' id='"+n+"_reset' class='fm-button ui-state-default ui-corner-all fm-button-icon-left ui-search'><span class='ui-icon ui-icon-arrowreturnthick-1-w'></span>"+d.Reset+"</a>",o="",t="",e,w=false,l=-1;if(d.showQuery)o="<a href='javascript:void(0)' id='"+
n+"_query' class='fm-button ui-state-default ui-corner-all fm-button-icon-left'><span class='ui-icon ui-icon-comment'></span>Query</a>";if(d.columns.length)q=d.columns;else a.each(q,function(m,v){if(!v.label)v.label=c.p.colNames[m];if(!w){var M=typeof v.search==="undefined"?true:v.search,B=v.hidden===true;if(v.searchoptions&&v.searchoptions.searchhidden===true&&M||M&&!B){w=true;e=v.index||v.name;l=m}}});if(!F&&e||d.multipleSearch===false){var k="eq";if(l>=0&&q[l].searchoptions&&q[l].searchoptions.sopt)k=
q[l].searchoptions.sopt[0];else if(d.sopt&&d.sopt.length)k=d.sopt[0];F={groupOp:"AND",rules:[{field:e,op:k,data:""}]}}w=false;if(d.tmplNames&&d.tmplNames.length){w=true;t=d.tmplLabel;t+="<select class='ui-template'>";t+="<option value='default'>Default</option>";a.each(d.tmplNames,function(m,v){t+="<option value='"+m+"'>"+v+"</option>"});t+="</select>"}u="<table class='EditTable' style='border:0px none;margin-top:5px' id='"+n+"_2'><tbody><tr><td colspan='2'><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr><td class='EditButton' style='text-align:left'>"+
p+t+"</td><td class='EditButton'>"+o+u+"</td></tr></tbody></table>";a("#"+n).jqFilter({columns:q,filter:d.loadDefaults?F:null,showQuery:d.showQuery,errorcheck:d.errorcheck,sopt:d.sopt,groupButton:d.multipleGroup,ruleButtons:d.multipleSearch,afterRedraw:d.afterRedraw,_gridsopt:a.jgrid.search.odata,onChange:function(){this.p.showQuery&&a(".query",this).html(this.toUserFriendlyString())}});s.append(u);w&&d.tmplFilters&&d.tmplFilters.length&&a(".ui-template",s).bind("change",function(){var m=a(this).val();
m=="default"?a("#"+n).jqFilter("addFilter",F):a("#"+n).jqFilter("addFilter",d.tmplFilters[parseInt(m,10)]);return false});if(d.multipleGroup===true)d.multipleSearch=true;if(a.isFunction(d.onInitializeSearch))d.onInitializeSearch(a("#"+n));d.layer?a.jgrid.createModal(D,s,d,"#gview_"+c.p.id,a("#gbox_"+c.p.id)[0],"#"+d.layer,{position:"relative"}):a.jgrid.createModal(D,s,d,"#gview_"+c.p.id,a("#gbox_"+c.p.id)[0]);o&&a("#"+n+"_query").bind("click",function(){a(".queryresult",s).toggle();return false});
if(d.stringResult===undefined)d.stringResult=d.multipleSearch;a("#"+n+"_search").bind("click",function(){var m=a("#"+n),v={},M,B=m.jqFilter("filterData");if(d.errorcheck){m[0].hideError();d.showQuery||m.jqFilter("toSQLString");if(m[0].p.error){m[0].showError();return false}}if(d.stringResult){try{M=xmlJsonClass.toJson(B,"","",false)}catch(U){try{M=JSON.stringify(B)}catch(g){}}if(typeof M==="string"){v[d.sFilter]=M;a.each([d.sField,d.sValue,d.sOper],function(){v[this]=""})}}else if(d.multipleSearch){v[d.sFilter]=
B;a.each([d.sField,d.sValue,d.sOper],function(){v[this]=""})}else{v[d.sField]=B.rules[0].field;v[d.sValue]=B.rules[0].data;v[d.sOper]=B.rules[0].op;v[d.sFilter]=""}c.p.search=true;a.extend(c.p.postData,v);if(a.isFunction(d.onSearch))d.onSearch();a(c).trigger("reloadGrid",[{page:1}]);d.closeAfterSearch&&a.jgrid.hideModal("#"+D.themodal,{gb:"#gbox_"+c.p.id,jqm:d.jqModal,onClose:d.onClose});return false});a("#"+n+"_reset").bind("click",function(){var m={},v=a("#"+n);c.p.search=false;if(d.multipleSearch===
false)m[d.sField]=m[d.sValue]=m[d.sOper]="";else m[d.sFilter]="";v[0].resetFilter();w&&a(".ui-template",s).val("default");a.extend(c.p.postData,m);if(a.isFunction(d.onReset))d.onReset();a(c).trigger("reloadGrid",[{page:1}]);return false});b();a(".fm-button:not(.ui-state-disabled)",s).hover(function(){a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")})}}})},editGridRow:function(d,b){var c=b=a.extend({top:0,left:0,width:300,height:"auto",dataheight:"auto",modal:false,
...
checkOnUpdate:false,_savedData:{},processing:false,onClose:null,ajaxEditOptions:{},serializeEditData:null,viewPagerButtons:true},a.jgrid.edit,b||{});return this.each(function(){function n(){a("#"+k+" > tbody > tr > td > .FormElement").each(function(){var f=a(".customelement",this);if(f.length){var h=a(f[0]).attr("name");a.each(e.p.colModel,function(){if(this.name===h&&this.editoptions&&a.isFunction(this.editoptions.custom_value)){try{j[h]=this.editoptions.custom_value(a("#"+a.jgrid.jqID(h),"#"+k),
"get");if(j[h]===undefined)throw"e1";}catch(r){r==="e1"?a.jgrid.info_dialog(jQuery.jgrid.errors.errcap,"function 'custom_value' "+a.jgrid.edit.msg.novalue,jQuery.jgrid.edit.bClose):a.jgrid.info_dialog(jQuery.jgrid.errors.errcap,r.message,jQuery.jgrid.edit.bClose)}return true}})}else{switch(a(this).get(0).type){case "checkbox":if(a(this).attr("checked"))j[this.name]=a(this).val();else{f=a(this).attr("offval");j[this.name]=f}break;case "select-one":j[this.name]=a("option:selected",this).val();J[this.name]=
a("option:selected",this).text();break;case "select-multiple":j[this.name]=a(this).val();j[this.name]=j[this.name]?j[this.name].join(","):"";var x=[];a("option:selected",this).each(function(r,H){x[r]=a(H).text()});J[this.name]=x.join(",");break;case "password":case "text":case "textarea":case "button":j[this.name]=a(this).val()}if(e.p.autoencode)j[this.name]=a.jgrid.htmlEncode(j[this.name])}});return true}function E(f,h,x,r){var H,C,z,I=0,y,N,G,V=[],K=false,aa="",O;for(O=1;O<=r;O++)aa+="<td class='CaptionTD'>&#160;</td><td class='DataTD'>&#160;</td>";
if(f!="_empty")K=a(h).jqGrid("getInd",f);a(h.p.colModel).each(function(T){H=this.name;N=(C=this.editrules&&this.editrules.edithidden===true?false:this.hidden===true?true:false)?"style='display:none'":"";if(H!=="cb"&&H!=="subgrid"&&this.editable===true&&H!=="rn"){if(K===false)y="";else if(H==h.p.ExpandColumn&&h.p.treeGrid===true)y=a("td:eq("+T+")",h.rows[K]).text();else{try{y=a.unformat(a("td:eq("+T+")",h.rows[K]),{rowId:f,colModel:this},T)}catch(fa){y=this.edittype&&this.edittype=="textarea"?a("td:eq("+
T+")",h.rows[K]).text():a("td:eq("+T+")",h.rows[K]).html()}if(!y||y=="&nbsp;"||y=="&#160;"||y.length==1&&y.charCodeAt(0)==160)y=""}var Y=a.extend({},this.editoptions||{},{id:H,name:H}),Z=a.extend({},{elmprefix:"",elmsuffix:"",rowabove:false,rowcontent:""},this.formoptions||{}),da=parseInt(Z.rowpos,10)||I+1,ga=parseInt((parseInt(Z.colpos,10)||1)*2,10);if(f=="_empty"&&Y.defaultValue)y=a.isFunction(Y.defaultValue)?Y.defaultValue():Y.defaultValue;if(!this.edittype)this.edittype="text";if(e.p.autoencode)y=
a.jgrid.htmlDecode(y);G=a.jgrid.createEl(this.edittype,Y,y,false,a.extend({},a.jgrid.ajaxOptions,h.p.ajaxSelectOptions||{}));if(y===""&&this.edittype=="checkbox")y=a(G).attr("offval");if(y===""&&this.edittype=="select")y=a("option:eq(0)",G).text();if(c.checkOnSubmit||c.checkOnUpdate)c._savedData[H]=y;a(G).addClass("FormElement");if(this.edittype=="text"||this.edittype=="textarea")a(G).addClass("ui-widget-content ui-corner-all");z=a(x).find("tr[rowpos="+da+"]");if(Z.rowabove){Y=a("<tr><td class='contentinfo' colspan='"+
r*2+"'>"+Z.rowcontent+"</td></tr>");a(x).append(Y);Y[0].rp=da}if(z.length===0){z=a("<tr "+N+" rowpos='"+da+"'></tr>").addClass("FormData").attr("id","tr_"+H);a(z).append(aa);a(x).append(z);z[0].rp=da}a("td:eq("+(ga-2)+")",z[0]).html(typeof Z.label==="undefined"?h.p.colNames[T]:Z.label);a("td:eq("+(ga-1)+")",z[0]).append(Z.elmprefix).append(G).append(Z.elmsuffix);V[I]=T;I++}});if(I>0){O=a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='"+(r*2-1)+"' class='DataTD'><input class='FormElement' id='id_g' type='text' name='"+
h.p.id+"_id' value='"+f+"'/></td></tr>");O[0].rp=I+999;a(x).append(O);if(c.checkOnSubmit||c.checkOnUpdate)c._savedData[h.p.id+"_id"]=f}return V}function D(f,h,x){var r,H=0,C,z,I,y,N;if(c.checkOnSubmit||c.checkOnUpdate){c._savedData={};c._savedData[h.p.id+"_id"]=f}var G=h.p.colModel;if(f=="_empty"){a(G).each(function(){r=this.name;I=a.extend({},this.editoptions||{});if((z=a("#"+a.jgrid.jqID(r),"#"+x))&&z.length&&z[0]!==null){y="";if(I.defaultValue){y=a.isFunction(I.defaultValue)?I.defaultValue():I.defaultValue;
if(z[0].type=="checkbox"){N=y.toLowerCase();if(N.search(/(false|0|no|off|undefined)/i)<0&&N!==""){z[0].checked=true;z[0].defaultChecked=true;z[0].value=y}else z.attr({checked:"",defaultChecked:""})}else z.val(y)}else if(z[0].type=="checkbox"){z[0].checked=false;z[0].defaultChecked=false;y=a(z).attr("offval")}else if(z[0].type&&z[0].type.substr(0,6)=="select")z[0].selectedIndex=0;else z.val(y);if(c.checkOnSubmit===true||c.checkOnUpdate)c._savedData[r]=y}});a("#id_g","#"+x).val(f)}else{var V=a(h).jqGrid("getInd",
f,true);if(V){a("td",V).each(function(K){r=G[K].name;if(r!=="cb"&&r!=="subgrid"&&r!=="rn"&&G[K].editable===true){if(r==h.p.ExpandColumn&&h.p.treeGrid===true)C=a(this).text();else try{C=a.unformat(a(this),{rowId:f,colModel:G[K]},K)}catch(aa){C=G[K].edittype=="textarea"?a(this).text():a(this).html()}if(e.p.autoencode)C=a.jgrid.htmlDecode(C);if(c.checkOnSubmit===true||c.checkOnUpdate)c._savedData[r]=C;r=a.jgrid.jqID(r);switch(G[K].edittype){case "password":case "text":case "button":case "image":case "textarea":if(C==
"&nbsp;"||C=="&#160;"||C.length==1&&C.charCodeAt(0)==160)C="";a("#"+r,"#"+x).val(C);break;case "select":var O=C.split(",");O=a.map(O,function(fa){return a.trim(fa)});a("#"+r+" option","#"+x).each(function(){this.selected=!G[K].editoptions.multiple&&(O[0]==a.trim(a(this).text())||O[0]==a.trim(a(this).val()))?true:G[K].editoptions.multiple?a.inArray(a.trim(a(this).text()),O)>-1||a.inArray(a.trim(a(this).val()),O)>-1?true:false:false});break;case "checkbox":C+="";if(G[K].editoptions&&G[K].editoptions.value)if(G[K].editoptions.value.split(":")[0]==
C){a("#"+r,"#"+x).attr("checked",true);a("#"+r,"#"+x).attr("defaultChecked",true)}else{a("#"+r,"#"+x).attr("checked",false);a("#"+r,"#"+x).attr("defaultChecked","")}else{C=C.toLowerCase();if(C.search(/(false|0|no|off|undefined)/i)<0&&C!==""){a("#"+r,"#"+x).attr("checked",true);a("#"+r,"#"+x).attr("defaultChecked",true)}else{a("#"+r,"#"+x).attr("checked",false);a("#"+r,"#"+x).attr("defaultChecked","")}}break;case "custom":try{if(G[K].editoptions&&a.isFunction(G[K].editoptions.custom_value))G[K].editoptions.custom_value(a("#"+
r,"#"+x),"set",C);else throw"e1";}catch(T){T=="e1"?a.jgrid.info_dialog(jQuery.jgrid.errors.errcap,"function 'custom_value' "+a.jgrid.edit.msg.nodefined,jQuery.jgrid.edit.bClose):a.jgrid.info_dialog(jQuery.jgrid.errors.errcap,T.message,jQuery.jgrid.edit.bClose)}}H++}});H>0&&a("#id_g","#"+k).val(f)}}}function F(){var f,h=[true,"",""],x={},r=e.p.prmNames,H,C,z,I;if(a.isFunction(c.beforeCheckValues)){var y=c.beforeCheckValues(j,a("#"+l),j[e.p.id+"_id"]=="_empty"?r.addoper:r.editoper);if(y&&typeof y===
"object")j=y}for(z in j)if(j.hasOwnProperty(z)){h=a.jgrid.checkValues(j[z],z,e);if(h[0]===false)break}if(h[0]){if(a.isFunction(c.onclickSubmit))x=c.onclickSubmit(c,j)||{};if(a.isFunction(c.beforeSubmit))h=c.beforeSubmit(j,a("#"+l))}if(h[0]&&!c.processing){c.processing=true;a("#sData","#"+k+"_2").addClass("ui-state-active");C=r.oper;H=r.id;j[C]=a.trim(j[e.p.id+"_id"])=="_empty"?r.addoper:r.editoper;if(j[C]!=r.addoper)j[H]=j[e.p.id+"_id"];else if(j[H]===undefined)j[H]=j[e.p.id+"_id"];delete j[e.p.id+
"_id"];j=a.extend(j,c.editData,x);if(e.p.treeGrid===true){if(j[C]==r.addoper){I=a(e).jqGrid("getGridParam","selrow");j[e.p.treeGridModel=="adjacency"?e.p.treeReader.parent_id_field:"parent_id"]=I}for(i in e.p.treeReader){x=e.p.treeReader[i];if(j.hasOwnProperty(x))j[C]==r.addoper&&i==="parent_id_field"||delete j[x]}}x=a.extend({url:c.url?c.url:a(e).jqGrid("getGridParam","editurl"),type:c.mtype,data:a.isFunction(c.serializeEditData)?c.serializeEditData(j):j,complete:function(N,G){if(G!="success"){h[0]=
false;h[1]=a.isFunction(c.errorTextFormat)?c.errorTextFormat(N):G+" Status: '"+N.statusText+"'. Error code: "+N.status}else if(a.isFunction(c.afterSubmit))h=c.afterSubmit(N,j);if(h[0]===false){a("#FormError>td","#"+k).html(h[1]);a("#FormError","#"+k).show()}else{a.each(e.p.colModel,function(){if(J[this.name]&&this.formatter&&this.formatter=="select")try{delete J[this.name]}catch(aa){}});j=a.extend(j,J);e.p.autoencode&&a.each(j,function(aa,O){j[aa]=a.jgrid.htmlDecode(O)});c.reloadAfterSubmit=c.reloadAfterSubmit&&
e.p.datatype!="local";if(j[C]==r.addoper){h[2]||(h[2]=a.jgrid.randId());j[H]=h[2];if(c.closeAfterAdd){if(c.reloadAfterSubmit)a(e).trigger("reloadGrid");else if(e.p.treeGrid===true)a(e).jqGrid("addChildNode",h[2],I,j);else{a(e).jqGrid("addRowData",h[2],j,b.addedrow);a(e).jqGrid("setSelection",h[2])}a.jgrid.hideModal("#"+m.themodal,{gb:"#gbox_"+w,jqm:b.jqModal,onClose:c.onClose})}else if(c.clearAfterAdd){if(c.reloadAfterSubmit)a(e).trigger("reloadGrid");else e.p.treeGrid===true?a(e).jqGrid("addChildNode",
h[2],I,j):a(e).jqGrid("addRowData",h[2],j,b.addedrow);D("_empty",e,l)}else if(c.reloadAfterSubmit)a(e).trigger("reloadGrid");else e.p.treeGrid===true?a(e).jqGrid("addChildNode",h[2],I,j):a(e).jqGrid("addRowData",h[2],j,b.addedrow)}else{if(c.reloadAfterSubmit){a(e).trigger("reloadGrid");c.closeAfterEdit||setTimeout(function(){a(e).jqGrid("setSelection",j[H])},1E3)}else e.p.treeGrid===true?a(e).jqGrid("setTreeRow",j[H],j):a(e).jqGrid("setRowData",j[H],j);c.closeAfterEdit&&a.jgrid.hideModal("#"+m.themodal,
{gb:"#gbox_"+w,jqm:b.jqModal,onClose:c.onClose})}if(a.isFunction(c.afterComplete)){f=N;setTimeout(function(){c.afterComplete(f,j,a("#"+l));f=null},500)}if(c.checkOnSubmit||c.checkOnUpdate){a("#"+l).data("disabled",false);if(c._savedData[e.p.id+"_id"]!="_empty")for(var V in c._savedData)if(j[V])c._savedData[V]=j[V]}}c.processing=false;a("#sData","#"+k+"_2").removeClass("ui-state-active");try{a(":input:visible","#"+l)[0].focus()}catch(K){}}},a.jgrid.ajaxOptions,c.ajaxEditOptions);if(!x.url&&!c.useDataProxy)if(a.isFunction(e.p.dataProxy))c.useDataProxy=
true;else{h[0]=false;h[1]+=" "+a.jgrid.errors.nourl}if(h[0])c.useDataProxy?e.p.dataProxy.call(e,x,"set_"+e.p.id):a.ajax(x)}if(h[0]===false){a("#FormError>td","#"+k).html(h[1]);a("#FormError","#"+k).show()}}function s(f,h){var x=false,r;for(r in f)if(f[r]!=h[r]){x=true;break}return x}function q(){a.each(e.p.colModel,function(f,h){if(h.editoptions&&h.editoptions.NullIfEmpty===true)if(j.hasOwnProperty(h.name)&&j[h.name]=="")j[h.name]="null"})}function u(){var f=true;a("#FormError","#"+k).hide();if(c.checkOnUpdate){j=
{};J={};n();S=a.extend({},j,J);if(P=s(S,c._savedData)){a("#"+l).data("disabled",true);a(".confirm","#"+m.themodal).show();f=false}else q()}return f}function p(){if(d!=="_empty"&&typeof e.p.savedRow!=="undefined"&&e.p.savedRow.length>0&&a.isFunction(a.fn.jqGrid.restoreRow))for(var f=0;f<e.p.savedRow.length;f++)if(e.p.savedRow[f].id==d){a(e).jqGrid("restoreRow",d);break}}function o(f,h){f===0?a("#pData","#"+k+"_2").addClass("ui-state-disabled"):a("#pData","#"+k+"_2").removeClass("ui-state-disabled");
f==h?a("#nData","#"+k+"_2").addClass("ui-state-disabled"):a("#nData","#"+k+"_2").removeClass("ui-state-disabled")}function t(){var f=a(e).jqGrid("getDataIDs"),h=a("#id_g","#"+k).val();return[a.inArray(h,f),f]}var e=this;if(e.grid&&d){var w=e.p.id,l="FrmGrid_"+w,k="TblGrid_"+w,m={themodal:"editmod"+w,modalhead:"edithd"+w,modalcontent:"editcnt"+w,scrollelm:l},v=a.isFunction(c.beforeShowForm)?c.beforeShowForm:false,M=a.isFunction(c.afterShowForm)?c.afterShowForm:false,B=a.isFunction(c.beforeInitData)?
c.beforeInitData:false,U=a.isFunction(c.onInitializeForm)?c.onInitializeForm:false,g=true,A=1,L=0,j,J,S,P;if(d==="new"){d="_empty";b.caption=c.addCaption}else b.caption=c.editCaption;b.recreateForm===true&&a("#"+m.themodal).html()!==null&&a("#"+m.themodal).remove();var Q=true;if(b.checkOnUpdate&&b.jqModal&&!b.modal)Q=false;if(a("#"+m.themodal).html()!==null){if(B){g=B(a("#"+l));if(typeof g=="undefined")g=true}if(g===false)return;p();a(".ui-jqdialog-title","#"+m.modalhead).html(b.caption);a("#FormError",
"#"+k).hide();if(c.topinfo){a(".topinfo","#"+k+"_2").html(c.topinfo);a(".tinfo","#"+k+"_2").show()}else a(".tinfo","#"+k+"_2").hide();if(c.bottominfo){a(".bottominfo","#"+k+"_2").html(c.bottominfo);a(".binfo","#"+k+"_2").show()}else a(".binfo","#"+k+"_2").hide();D(d,e,l);d=="_empty"||!c.viewPagerButtons?a("#pData, #nData","#"+k+"_2").hide():a("#pData, #nData","#"+k+"_2").show();if(c.processing===true){c.processing=false;a("#sData","#"+k+"_2").removeClass("ui-state-active")}if(a("#"+l).data("disabled")===
true){a(".confirm","#"+m.themodal).hide();a("#"+l).data("disabled",false)}v&&v(a("#"+l));a("#"+m.themodal).data("onClose",c.onClose);a.jgrid.viewModal("#"+m.themodal,{gbox:"#gbox_"+w,jqm:b.jqModal,jqM:false,overlay:b.overlay,modal:b.modal});Q||a(".jqmOverlay").click(function(){if(!u())return false;a.jgrid.hideModal("#"+m.themodal,{gb:"#gbox_"+w,jqm:b.jqModal,onClose:c.onClose});return false});M&&M(a("#"+l))}else{var R=isNaN(b.dataheight)?b.dataheight:b.dataheight+"px";R=a("<form name='FormPost' id='"+
l+"' class='FormGrid' onSubmit='return false;' style='width:100%;overflow:auto;position:relative;height:"+R+";'></form>").data("disabled",false);var W=a("<table id='"+k+"' class='EditTable' cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>");if(B){g=B(a("#"+l));if(typeof g=="undefined")g=true}if(g===false)return;p();a(e.p.colModel).each(function(){var f=this.formoptions;A=Math.max(A,f?f.colpos||0:0);L=Math.max(L,f?f.rowpos||0:0)});a(R).append(W);B=a("<tr id='FormError' style='display:none'><td class='ui-state-error' colspan='"+
A*2+"'></td></tr>");B[0].rp=0;a(W).append(B);B=a("<tr style='display:none' class='tinfo'><td class='topinfo' colspan='"+A*2+"'>"+c.topinfo+"</td></tr>");B[0].rp=0;a(W).append(B);g=(B=e.p.direction=="rtl"?true:false)?"nData":"pData";var X=B?"pData":"nData";E(d,e,W,A);g="<a href='javascript:void(0)' id='"+g+"' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w'></span></a>";X="<a href='javascript:void(0)' id='"+X+"' class='fm-button ui-state-default ui-corner-right'><span class='ui-icon ui-icon-triangle-1-e'></span></a>";
var $="<a href='javascript:void(0)' id='sData' class='fm-button ui-state-default ui-corner-all'>"+b.bSubmit+"</a>",ca="<a href='javascript:void(0)' id='cData' class='fm-button ui-state-default ui-corner-all'>"+b.bCancel+"</a>";g="<table border='0' cellspacing='0' cellpadding='0' class='EditTable' id='"+k+"_2'><tbody><tr><td colspan='2'><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr id='Act_Buttons'><td class='navButton'>"+(B?X+g:g+X)+"</td><td class='EditButton'>"+$+ca+"</td></tr>";
g+="<tr style='display:none' class='binfo'><td class='bottominfo' colspan='2'>"+c.bottominfo+"</td></tr>";g+="</tbody></table>";if(L>0){var ba=[];a.each(a(W)[0].rows,function(f,h){ba[f]=h});ba.sort(function(f,h){if(f.rp>h.rp)return 1;if(f.rp<h.rp)return-1;return 0});a.each(ba,function(f,h){a("tbody",W).append(h)})}b.gbox="#gbox_"+w;var ea=false;if(b.closeOnEscape===true){b.closeOnEscape=false;ea=true}R=a("<span></span>").append(R).append(g);a.jgrid.createModal(m,R,b,"#gview_"+e.p.id,a("#gbox_"+e.p.id)[0]);
if(B){a("#pData, #nData","#"+k+"_2").css("float","right");a(".EditButton","#"+k+"_2").css("text-align","left")}c.topinfo&&a(".tinfo","#"+k+"_2").show();c.bottominfo&&a(".binfo","#"+k+"_2").show();g=R=null;a("#"+m.themodal).keydown(function(f){var h=f.target;if(a("#"+l).data("disabled")===true)return false;if(c.savekey[0]===true&&f.which==c.savekey[1])if(h.tagName!="TEXTAREA"){a("#sData","#"+k+"_2").trigger("click");return false}if(f.which===27){if(!u())return false;ea&&a.jgrid.hideModal(this,{gb:b.gbox,
jqm:b.jqModal,onClose:c.onClose});return false}if(c.navkeys[0]===true){if(a("#id_g","#"+k).val()=="_empty")return true;if(f.which==c.navkeys[1]){a("#pData","#"+k+"_2").trigger("click");return false}if(f.which==c.navkeys[2]){a("#nData","#"+k+"_2").trigger("click");return false}}});if(b.checkOnUpdate){a("a.ui-jqdialog-titlebar-close span","#"+m.themodal).removeClass("jqmClose");a("a.ui-jqdialog-titlebar-close","#"+m.themodal).unbind("click").click(function(){if(!u())return false;a.jgrid.hideModal("#"+
m.themodal,{gb:"#gbox_"+w,jqm:b.jqModal,onClose:c.onClose});return false})}b.saveicon=a.extend([true,"left","ui-icon-disk"],b.saveicon);b.closeicon=a.extend([true,"left","ui-icon-close"],b.closeicon);if(b.saveicon[0]===true)a("#sData","#"+k+"_2").addClass(b.saveicon[1]=="right"?"fm-button-icon-right":"fm-button-icon-left").append("<span class='ui-icon "+b.saveicon[2]+"'></span>");if(b.closeicon[0]===true)a("#cData","#"+k+"_2").addClass(b.closeicon[1]=="right"?"fm-button-icon-right":"fm-button-icon-left").append("<span class='ui-icon "+
b.closeicon[2]+"'></span>");if(c.checkOnSubmit||c.checkOnUpdate){$="<a href='javascript:void(0)' id='sNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>"+b.bYes+"</a>";X="<a href='javascript:void(0)' id='nNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>"+b.bNo+"</a>";ca="<a href='javascript:void(0)' id='cNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>"+b.bExit+"</a>";R=b.zIndex||999;R++;a("<div class='ui-widget-overlay jqgrid-overlay confirm' style='z-index:"+
R+";display:none;'>&#160;"+(a.browser.msie&&a.browser.version==6?'<iframe style="display:block;position:absolute;z-index:-1;filter:Alpha(Opacity=\'0\');" src="javascript:false;"></iframe>':"")+"</div><div class='confirm ui-widget-content ui-jqconfirm' style='z-index:"+(R+1)+"'>"+b.saveData+"<br/><br/>"+$+X+ca+"</div>").insertAfter("#"+l);a("#sNew","#"+m.themodal).click(function(){F();a("#"+l).data("disabled",false);a(".confirm","#"+m.themodal).hide();return false});a("#nNew","#"+m.themodal).click(function(){a(".confirm",
"#"+m.themodal).hide();a("#"+l).data("disabled",false);setTimeout(function(){a(":input","#"+l)[0].focus()},0);return false});a("#cNew","#"+m.themodal).click(function(){a(".confirm","#"+m.themodal).hide();a("#"+l).data("disabled",false);a.jgrid.hideModal("#"+m.themodal,{gb:"#gbox_"+w,jqm:b.jqModal,onClose:c.onClose});return false})}U&&U(a("#"+l));d=="_empty"||!c.viewPagerButtons?a("#pData,#nData","#"+k+"_2").hide():a("#pData,#nData","#"+k+"_2").show();v&&v(a("#"+l));a("#"+m.themodal).data("onClose",
c.onClose);a.jgrid.viewModal("#"+m.themodal,{gbox:"#gbox_"+w,jqm:b.jqModal,overlay:b.overlay,modal:b.modal});Q||a(".jqmOverlay").click(function(){if(!u())return false;a.jgrid.hideModal("#"+m.themodal,{gb:"#gbox_"+w,jqm:b.jqModal,onClose:c.onClose});return false});M&&M(a("#"+l));a(".fm-button","#"+m.themodal).hover(function(){a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")});a("#sData","#"+k+"_2").click(function(){j={};J={};a("#FormError","#"+k).hide();n();q();
if(j[e.p.id+"_id"]=="_empty")F();else if(b.checkOnSubmit===true){S=a.extend({},j,J);if(P=s(S,c._savedData)){a("#"+l).data("disabled",true);a(".confirm","#"+m.themodal).show()}else F()}else F();return false});a("#cData","#"+k+"_2").click(function(){if(!u())return false;a.jgrid.hideModal("#"+m.themodal,{gb:"#gbox_"+w,jqm:b.jqModal,onClose:c.onClose});return false});a("#nData","#"+k+"_2").click(function(){if(!u())return false;a("#FormError","#"+k).hide();var f=t();f[0]=parseInt(f[0],10);if(f[0]!=-1&&
f[1][f[0]+1]){if(a.isFunction(b.onclickPgButtons))b.onclickPgButtons("next",a("#"+l),f[1][f[0]]);D(f[1][f[0]+1],e,l);a(e).jqGrid("setSelection",f[1][f[0]+1]);a.isFunction(b.afterclickPgButtons)&&b.afterclickPgButtons("next",a("#"+l),f[1][f[0]+1]);o(f[0]+1,f[1].length-1)}return false});a("#pData","#"+k+"_2").click(function(){if(!u())return false;a("#FormError","#"+k).hide();var f=t();if(f[0]!=-1&&f[1][f[0]-1]){if(a.isFunction(b.onclickPgButtons))b.onclickPgButtons("prev",a("#"+l),f[1][f[0]]);D(f[1][f[0]-
1],e,l);a(e).jqGrid("setSelection",f[1][f[0]-1]);a.isFunction(b.afterclickPgButtons)&&b.afterclickPgButtons("prev",a("#"+l),f[1][f[0]-1]);o(f[0]-1,f[1].length-1)}return false})}v=t();o(v[0],v[1].length-1)}})},viewGridRow:function(d,b){b=a.extend({top:0,left:0,width:0,height:"auto",dataheight:"auto",modal:false,overlay:10,drag:true,resize:true,jqModal:true,closeOnEscape:false,labelswidth:"30%",closeicon:[],navkeys:[false,38,40],onClose:null,beforeShowForm:null,beforeInitData:null,viewPagerButtons:true},
a.jgrid.view,b||{});return this.each(function(){function c(){if(b.closeOnEscape===true||b.navkeys[0]===true)setTimeout(function(){a(".ui-jqdialog-titlebar-close","#"+o.modalhead).focus()},0)}function n(g,A,L,j){for(var J,S,P,Q=0,R,W,X=[],$=false,ca="<td class='CaptionTD form-view-label ui-widget-content' width='"+b.labelswidth+"'>&#160;</td><td class='DataTD form-view-data ui-helper-reset ui-widget-content'>&#160;</td>",ba="",ea=["integer","number","currency"],f=0,h=0,x,r,H,C=1;C<=j;C++)ba+=C==1?
ca:"<td class='CaptionTD form-view-label ui-widget-content'>&#160;</td><td class='DataTD form-view-data ui-widget-content'>&#160;</td>";a(A.p.colModel).each(function(){S=this.editrules&&this.editrules.edithidden===true?false:this.hidden===true?true:false;if(!S&&this.align==="right")if(this.formatter&&a.inArray(this.formatter,ea)!==-1)f=Math.max(f,parseInt(this.width,10));else h=Math.max(h,parseInt(this.width,10))});x=f!==0?f:h!==0?h:0;$=a(A).jqGrid("getInd",g);a(A.p.colModel).each(function(z){J=this.name;
r=false;W=(S=this.editrules&&this.editrules.edithidden===true?false:this.hidden===true?true:false)?"style='display:none'":"";H=typeof this.viewable!="boolean"?true:this.viewable;if(J!=="cb"&&J!=="subgrid"&&J!=="rn"&&H){R=$===false?"":J==A.p.ExpandColumn&&A.p.treeGrid===true?a("td:eq("+z+")",A.rows[$]).text():a("td:eq("+z+")",A.rows[$]).html();r=this.align==="right"&&x!==0?true:false;a.extend({},this.editoptions||{},{id:J,name:J});var I=a.extend({},{rowabove:false,rowcontent:""},this.formoptions||
{}),y=parseInt(I.rowpos,10)||Q+1,N=parseInt((parseInt(I.colpos,10)||1)*2,10);if(I.rowabove){var G=a("<tr><td class='contentinfo' colspan='"+j*2+"'>"+I.rowcontent+"</td></tr>");a(L).append(G);G[0].rp=y}P=a(L).find("tr[rowpos="+y+"]");if(P.length===0){P=a("<tr "+W+" rowpos='"+y+"'></tr>").addClass("FormData").attr("id","trv_"+J);a(P).append(ba);a(L).append(P);P[0].rp=y}a("td:eq("+(N-2)+")",P[0]).html("<b>"+(typeof I.label==="undefined"?A.p.colNames[z]:I.label)+"</b>");a("td:eq("+(N-1)+")",P[0]).append("<span>"+
R+"</span>").attr("id","v_"+J);r&&a("td:eq("+(N-1)+") span",P[0]).css({"text-align":"right",width:x+"px"});X[Q]=z;Q++}});if(Q>0){g=a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='"+(j*2-1)+"' class='DataTD'><input class='FormElement' id='id_g' type='text' name='id' value='"+g+"'/></td></tr>");g[0].rp=Q+99;a(L).append(g)}return X}function E(g,A){var L,j,J=0,S,P;if(P=a(A).jqGrid("getInd",g,true)){a("td",P).each(function(Q){L=A.p.colModel[Q].name;j=A.p.colModel[Q].editrules&&
A.p.colModel[Q].editrules.edithidden===true?false:A.p.colModel[Q].hidden===true?true:false;if(L!=="cb"&&L!=="subgrid"&&L!=="rn"){S=L==A.p.ExpandColumn&&A.p.treeGrid===true?a(this).text():a(this).html();a.extend({},A.p.colModel[Q].editoptions||{});L=a.jgrid.jqID("v_"+L);a("#"+L+" span","#"+p).html(S);j&&a("#"+L,"#"+p).parents("tr:first").hide();J++}});J>0&&a("#id_g","#"+p).val(g)}}function D(g,A){g===0?a("#pData","#"+p+"_2").addClass("ui-state-disabled"):a("#pData","#"+p+"_2").removeClass("ui-state-disabled");
g==A?a("#nData","#"+p+"_2").addClass("ui-state-disabled"):a("#nData","#"+p+"_2").removeClass("ui-state-disabled")}function F(){var g=a(s).jqGrid("getDataIDs"),A=a("#id_g","#"+p).val();return[a.inArray(A,g),g]}var s=this;if(s.grid&&d){if(!b.imgpath)b.imgpath=s.p.imgpath;var q=s.p.id,u="ViewGrid_"+q,p="ViewTbl_"+q,o={themodal:"viewmod"+q,modalhead:"viewhd"+q,modalcontent:"viewcnt"+q,scrollelm:u},t=a.isFunction(b.beforeInitData)?b.beforeInitData:false,e=true,w=1,l=0;if(a("#"+o.themodal).html()!==null){if(t){e=
t(a("#"+u));if(typeof e=="undefined")e=true}if(e===false)return;a(".ui-jqdialog-title","#"+o.modalhead).html(b.caption);a("#FormError","#"+p).hide();E(d,s);a.isFunction(b.beforeShowForm)&&b.beforeShowForm(a("#"+u));a.jgrid.viewModal("#"+o.themodal,{gbox:"#gbox_"+q,jqm:b.jqModal,jqM:false,overlay:b.overlay,modal:b.modal});c()}else{var k=isNaN(b.dataheight)?b.dataheight:b.dataheight+"px";k=a("<form name='FormPost' id='"+u+"' class='FormGrid' style='width:100%;overflow:auto;position:relative;height:"+
k+";'></form>");var m=a("<table id='"+p+"' class='EditTable' cellspacing='1' cellpadding='2' border='0' style='table-layout:fixed'><tbody></tbody></table>");if(t){e=t(a("#"+u));if(typeof e=="undefined")e=true}if(e===false)return;a(s.p.colModel).each(function(){var g=this.formoptions;w=Math.max(w,g?g.colpos||0:0);l=Math.max(l,g?g.rowpos||0:0)});a(k).append(m);n(d,s,m,w);t=s.p.direction=="rtl"?true:false;e="<a href='javascript:void(0)' id='"+(t?"nData":"pData")+"' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w'></span></a>";
var v="<a href='javascript:void(0)' id='"+(t?"pData":"nData")+"' class='fm-button ui-state-default ui-corner-right'><span class='ui-icon ui-icon-triangle-1-e'></span></a>",M="<a href='javascript:void(0)' id='cData' class='fm-button ui-state-default ui-corner-all'>"+b.bClose+"</a>";if(l>0){var B=[];a.each(a(m)[0].rows,function(g,A){B[g]=A});B.sort(function(g,A){if(g.rp>A.rp)return 1;if(g.rp<A.rp)return-1;return 0});a.each(B,function(g,A){a("tbody",m).append(A)})}b.gbox="#gbox_"+q;var U=false;if(b.closeOnEscape===
true){b.closeOnEscape=false;U=true}k=a("<span></span>").append(k).append("<table border='0' class='EditTable' id='"+p+"_2'><tbody><tr id='Act_Buttons'><td class='navButton' width='"+b.labelswidth+"'>"+(t?v+e:e+v)+"</td><td class='EditButton'>"+M+"</td></tr></tbody></table>");a.jgrid.createModal(o,k,b,"#gview_"+s.p.id,a("#gview_"+s.p.id)[0]);if(t){a("#pData, #nData","#"+p+"_2").css("float","right");a(".EditButton","#"+p+"_2").css("text-align","left")}b.viewPagerButtons||a("#pData, #nData","#"+p+"_2").hide();
k=null;a("#"+o.themodal).keydown(function(g){if(g.which===27){U&&a.jgrid.hideModal(this,{gb:b.gbox,jqm:b.jqModal,onClose:b.onClose});return false}if(b.navkeys[0]===true){if(g.which===b.navkeys[1]){a("#pData","#"+p+"_2").trigger("click");return false}if(g.which===b.navkeys[2]){a("#nData","#"+p+"_2").trigger("click");return false}}});b.closeicon=a.extend([true,"left","ui-icon-close"],b.closeicon);if(b.closeicon[0]===true)a("#cData","#"+p+"_2").addClass(b.closeicon[1]=="right"?"fm-button-icon-right":
"fm-button-icon-left").append("<span class='ui-icon "+b.closeicon[2]+"'></span>");a.isFunction(b.beforeShowForm)&&b.beforeShowForm(a("#"+u));a.jgrid.viewModal("#"+o.themodal,{gbox:"#gbox_"+q,jqm:b.jqModal,modal:b.modal});a(".fm-button:not(.ui-state-disabled)","#"+p+"_2").hover(function(){a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")});c();a("#cData","#"+p+"_2").click(function(){a.jgrid.hideModal("#"+o.themodal,{gb:"#gbox_"+q,jqm:b.jqModal,onClose:b.onClose});
return false});a("#nData","#"+p+"_2").click(function(){a("#FormError","#"+p).hide();var g=F();g[0]=parseInt(g[0],10);if(g[0]!=-1&&g[1][g[0]+1]){if(a.isFunction(b.onclickPgButtons))b.onclickPgButtons("next",a("#"+u),g[1][g[0]]);E(g[1][g[0]+1],s);a(s).jqGrid("setSelection",g[1][g[0]+1]);a.isFunction(b.afterclickPgButtons)&&b.afterclickPgButtons("next",a("#"+u),g[1][g[0]+1]);D(g[0]+1,g[1].length-1)}c();return false});a("#pData","#"+p+"_2").click(function(){a("#FormError","#"+p).hide();var g=F();if(g[0]!=
-1&&g[1][g[0]-1]){if(a.isFunction(b.onclickPgButtons))b.onclickPgButtons("prev",a("#"+u),g[1][g[0]]);E(g[1][g[0]-1],s);a(s).jqGrid("setSelection",g[1][g[0]-1]);a.isFunction(b.afterclickPgButtons)&&b.afterclickPgButtons("prev",a("#"+u),g[1][g[0]-1]);D(g[0]-1,g[1].length-1)}c();return false})}k=F();D(k[0],k[1].length-1)}})},delGridRow:function(d,b){var c=b=a.extend({top:0,left:0,width:240,height:"auto",dataheight:"auto",modal:false,overlay:10,drag:true,resize:true,url:"",mtype:"POST",reloadAfterSubmit:true,
beforeShowForm:null,beforeInitData:null,afterShowForm:null,beforeSubmit:null,onclickSubmit:null,afterSubmit:null,jqModal:true,closeOnEscape:false,delData:{},delicon:[],cancelicon:[],onClose:null,ajaxDelOptions:{},processing:false,serializeDelData:null,useDataProxy:false},a.jgrid.del,b||{});return this.each(function(){var n=this;if(n.grid)if(d){var E=a.isFunction(b.beforeShowForm),D=a.isFunction(b.afterShowForm),F=a.isFunction(b.beforeInitData)?b.beforeInitData:false,s=n.p.id,q={},u=true,p="DelTbl_"+
s,o,t,e,w,l={themodal:"delmod"+s,modalhead:"delhd"+s,modalcontent:"delcnt"+s,scrollelm:p};if(jQuery.isArray(d))d=d.join();if(a("#"+l.themodal).html()!==null){if(F){u=F(a("#"+p));if(typeof u=="undefined")u=true}if(u===false)return;a("#DelData>td","#"+p).text(d);a("#DelError","#"+p).hide();if(c.processing===true){c.processing=false;a("#dData","#"+p).removeClass("ui-state-active")}E&&b.beforeShowForm(a("#"+p));a.jgrid.viewModal("#"+l.themodal,{gbox:"#gbox_"+s,jqm:b.jqModal,jqM:false,overlay:b.overlay,
modal:b.modal})}else{var k=isNaN(b.dataheight)?b.dataheight:b.dataheight+"px";k="<div id='"+p+"' class='formdata' style='width:100%;overflow:auto;position:relative;height:"+k+";'>";k+="<table class='DelTable'><tbody>";k+="<tr id='DelError' style='display:none'><td class='ui-state-error'></td></tr>";k+="<tr id='DelData' style='display:none'><td >"+d+"</td></tr>";k+='<tr><td class="delmsg" style="white-space:pre;">'+b.msg+"</td></tr><tr><td >&#160;</td></tr>";k+="</tbody></table></div>";k+="<table cellspacing='0' cellpadding='0' border='0' class='EditTable' id='"+
p+"_2'><tbody><tr><td><hr class='ui-widget-content' style='margin:1px'/></td></tr></tr><tr><td class='DelButton EditButton'>"+("<a href='javascript:void(0)' id='dData' class='fm-button ui-state-default ui-corner-all'>"+b.bSubmit+"</a>")+"&#160;"+("<a href='javascript:void(0)' id='eData' class='fm-button ui-state-default ui-corner-all'>"+b.bCancel+"</a>")+"</td></tr></tbody></table>";b.gbox="#gbox_"+s;a.jgrid.createModal(l,k,b,"#gview_"+n.p.id,a("#gview_"+n.p.id)[0]);if(F){u=F(a("#"+p));if(typeof u==
"undefined")u=true}if(u===false)return;a(".fm-button","#"+p+"_2").hover(function(){a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")});b.delicon=a.extend([true,"left","ui-icon-scissors"],b.delicon);b.cancelicon=a.extend([true,"left","ui-icon-cancel"],b.cancelicon);if(b.delicon[0]===true)a("#dData","#"+p+"_2").addClass(b.delicon[1]=="right"?"fm-button-icon-right":"fm-button-icon-left").append("<span class='ui-icon "+b.delicon[2]+"'></span>");if(b.cancelicon[0]===
true)a("#eData","#"+p+"_2").addClass(b.cancelicon[1]=="right"?"fm-button-icon-right":"fm-button-icon-left").append("<span class='ui-icon "+b.cancelicon[2]+"'></span>");a("#dData","#"+p+"_2").click(function(){var m=[true,""];q={};var v=a("#DelData>td","#"+p).text();if(a.isFunction(b.onclickSubmit))q=b.onclickSubmit(c,v)||{};if(a.isFunction(b.beforeSubmit))m=b.beforeSubmit(v);if(m[0]&&!c.processing){c.processing=true;a(this).addClass("ui-state-active");e=n.p.prmNames;o=a.extend({},c.delData,q);w=e.oper;
o[w]=e.deloper;t=e.id;o[t]=v;var M=a.extend({url:c.url?c.url:a(n).jqGrid("getGridParam","editurl"),type:b.mtype,data:a.isFunction(b.serializeDelData)?b.serializeDelData(o):o,complete:function(B,U){if(U!="success"){m[0]=false;m[1]=a.isFunction(c.errorTextFormat)?c.errorTextFormat(B):U+" Status: '"+B.statusText+"'. Error code: "+B.status}else if(a.isFunction(c.afterSubmit))m=c.afterSubmit(B,o);if(m[0]===false){a("#DelError>td","#"+p).html(m[1]);a("#DelError","#"+p).show()}else{if(c.reloadAfterSubmit&&
n.p.datatype!="local")a(n).trigger("reloadGrid");else{var g=[];g=v.split(",");if(n.p.treeGrid===true)try{a(n).jqGrid("delTreeNode",g[0])}catch(A){}else for(var L=0;L<g.length;L++)a(n).jqGrid("delRowData",g[L]);n.p.selrow=null;n.p.selarrrow=[]}a.isFunction(c.afterComplete)&&setTimeout(function(){c.afterComplete(B,v)},500)}c.processing=false;a("#dData","#"+p+"_2").removeClass("ui-state-active");m[0]&&a.jgrid.hideModal("#"+l.themodal,{gb:"#gbox_"+s,jqm:b.jqModal,onClose:c.onClose})}},a.jgrid.ajaxOptions,
b.ajaxDelOptions);if(!M.url&&!c.useDataProxy)if(a.isFunction(n.p.dataProxy))c.useDataProxy=true;else{m[0]=false;m[1]+=" "+a.jgrid.errors.nourl}if(m[0])c.useDataProxy?n.p.dataProxy.call(n,M,"del_"+n.p.id):a.ajax(M)}if(m[0]===false){a("#DelError>td","#"+p).html(m[1]);a("#DelError","#"+p).show()}return false});a("#eData","#"+p+"_2").click(function(){a.jgrid.hideModal("#"+l.themodal,{gb:"#gbox_"+s,jqm:b.jqModal,onClose:c.onClose});return false});E&&b.beforeShowForm(a("#"+p));a.jgrid.viewModal("#"+l.themodal,
{gbox:"#gbox_"+s,jqm:b.jqModal,overlay:b.overlay,modal:b.modal})}D&&b.afterShowForm(a("#"+p));b.closeOnEscape===true&&setTimeout(function(){a(".ui-jqdialog-titlebar-close","#"+l.modalhead).focus()},0)}})},navGrid:function(d,b,c,n,E,D,F){b=a.extend({edit:true,editicon:"ui-icon-pencil",add:true,addicon:"ui-icon-plus",del:true,delicon:"ui-icon-trash",search:true,searchicon:"ui-icon-search",refresh:true,refreshicon:"ui-icon-refresh",refreshstate:"firstpage",view:false,viewicon:"ui-icon-document",position:"left",
closeOnEscape:true,beforeRefresh:null,afterRefresh:null,cloneToTop:false},a.jgrid.nav,b||{});return this.each(function(){if(!this.nav){var s={themodal:"alertmod",modalhead:"alerthd",modalcontent:"alertcnt"},q=this,u,p,o;if(!(!q.grid||typeof d!="string")){if(a("#"+s.themodal).html()===null){if(typeof window.innerWidth!="undefined"){u=window.innerWidth;p=window.innerHeight}else if(typeof document.documentElement!="undefined"&&typeof document.documentElement.clientWidth!="undefined"&&document.documentElement.clientWidth!==
0){u=document.documentElement.clientWidth;p=document.documentElement.clientHeight}else{u=1024;p=768}a.jgrid.createModal(s,"<div>"+b.alerttext+"</div><span tabindex='0'><span tabindex='-1' id='jqg_alrt'></span></span>",{gbox:"#gbox_"+q.p.id,jqModal:true,drag:true,resize:true,caption:b.alertcap,top:p/2-25,left:u/2-100,width:200,height:"auto",closeOnEscape:b.closeOnEscape},"","",true)}u=1;if(b.cloneToTop&&q.p.toppager)u=2;for(p=0;p<u;p++){var t=a("<table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table navtable' style='float:left;table-layout:auto;'><tbody><tr></tr></tbody></table>"),
e,w;if(p===0){e=d;w=q.p.id;if(e==q.p.toppager){w+="_top";u=1}}else{e=q.p.toppager;w=q.p.id+"_top"}q.p.direction=="rtl"&&a(t).attr("dir","rtl").css("float","right");if(b.add){n=n||{};o=a("<td class='ui-pg-button ui-corner-all'></td>");a(o).append("<div class='ui-pg-div'><span class='ui-icon "+b.addicon+"'></span>"+b.addtext+"</div>");a("tr",t).append(o);a(o,t).attr({title:b.addtitle||"",id:n.id||"add_"+w}).click(function(){a(this).hasClass("ui-state-disabled")||(a.isFunction(b.addfunc)?b.addfunc():
a(q).jqGrid("editGridRow","new",n));return false}).hover(function(){a(this).hasClass("ui-state-disabled")||a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")});o=null}if(b.edit){o=a("<td class='ui-pg-button ui-corner-all'></td>");c=c||{};a(o).append("<div class='ui-pg-div'><span class='ui-icon "+b.editicon+"'></span>"+b.edittext+"</div>");a("tr",t).append(o);a(o,t).attr({title:b.edittitle||"",id:c.id||"edit_"+w}).click(function(){if(!a(this).hasClass("ui-state-disabled")){var l=
q.p.selrow;if(l)a.isFunction(b.editfunc)?b.editfunc(l):a(q).jqGrid("editGridRow",l,c);else{a.jgrid.viewModal("#"+s.themodal,{gbox:"#gbox_"+q.p.id,jqm:true});a("#jqg_alrt").focus()}}return false}).hover(function(){a(this).hasClass("ui-state-disabled")||a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")});o=null}if(b.view){o=a("<td class='ui-pg-button ui-corner-all'></td>");F=F||{};a(o).append("<div class='ui-pg-div'><span class='ui-icon "+b.viewicon+"'></span>"+b.viewtext+
"</div>");a("tr",t).append(o);a(o,t).attr({title:b.viewtitle||"",id:F.id||"view_"+w}).click(function(){if(!a(this).hasClass("ui-state-disabled")){var l=q.p.selrow;if(l)a.isFunction(b.viewfunc)?b.viewfunc(l):a(q).jqGrid("viewGridRow",l,F);else{a.jgrid.viewModal("#"+s.themodal,{gbox:"#gbox_"+q.p.id,jqm:true});a("#jqg_alrt").focus()}}return false}).hover(function(){a(this).hasClass("ui-state-disabled")||a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")});o=null}if(b.del){o=
a("<td class='ui-pg-button ui-corner-all'></td>");E=E||{};a(o).append("<div class='ui-pg-div'><span class='ui-icon "+b.delicon+"'></span>"+b.deltext+"</div>");a("tr",t).append(o);a(o,t).attr({title:b.deltitle||"",id:E.id||"del_"+w}).click(function(){if(!a(this).hasClass("ui-state-disabled")){var l;if(q.p.multiselect){l=q.p.selarrrow;if(l.length===0)l=null}else l=q.p.selrow;if(l)"function"==typeof b.delfunc?b.delfunc(l):a(q).jqGrid("delGridRow",l,E);else{a.jgrid.viewModal("#"+s.themodal,{gbox:"#gbox_"+
q.p.id,jqm:true});a("#jqg_alrt").focus()}}return false}).hover(function(){a(this).hasClass("ui-state-disabled")||a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")});o=null}if(b.add||b.edit||b.del||b.view)a("tr",t).append("<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='ui-separator'></span></td>");if(b.search){o=a("<td class='ui-pg-button ui-corner-all'></td>");D=D||{};a(o).append("<div class='ui-pg-div'><span class='ui-icon "+b.searchicon+
"'></span>"+b.searchtext+"</div>");a("tr",t).append(o);a(o,t).attr({title:b.searchtitle||"",id:D.id||"search_"+w}).click(function(){a(this).hasClass("ui-state-disabled")||a(q).jqGrid("searchGrid",D);return false}).hover(function(){a(this).hasClass("ui-state-disabled")||a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")});D.showOnLoad&&D.showOnLoad===true&&a(o,t).click();o=null}if(b.refresh){o=a("<td class='ui-pg-button ui-corner-all'></td>");a(o).append("<div class='ui-pg-div'><span class='ui-icon "+
b.refreshicon+"'></span>"+b.refreshtext+"</div>");a("tr",t).append(o);a(o,t).attr({title:b.refreshtitle||"",id:"refresh_"+w}).click(function(){if(!a(this).hasClass("ui-state-disabled")){a.isFunction(b.beforeRefresh)&&b.beforeRefresh();q.p.search=false;try{var l=q.p.id;q.p.postData.filters="";a("#fbox_"+l).jqFilter("resetFilter");a.isFunction(q.clearToolbar)&&q.clearToolbar(false)}catch(k){}switch(b.refreshstate){case "firstpage":a(q).trigger("reloadGrid",[{page:1}]);break;case "current":a(q).trigger("reloadGrid",
[{current:true}])}a.isFunction(b.afterRefresh)&&b.afterRefresh()}return false}).hover(function(){a(this).hasClass("ui-state-disabled")||a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")});o=null}o=a(".ui-jqgrid").css("font-size")||"11px";a("body").append("<div id='testpg2' class='ui-jqgrid ui-widget ui-widget-content' style='font-size:"+o+";visibility:hidden;' ></div>");o=a(t).clone().appendTo("#testpg2").width();a("#testpg2").remove();a(e+"_"+b.position,e).append(t);
if(q.p._nvtd){if(o>q.p._nvtd[0]){a(e+"_"+b.position,e).width(o);q.p._nvtd[0]=o}q.p._nvtd[1]=o}t=o=o=null;this.nav=true}}}})},navButtonAdd:function(d,b){b=a.extend({caption:"newButton",title:"",buttonicon:"ui-icon-newwin",onClickButton:null,position:"last",cursor:"pointer"},b||{});return this.each(function(){if(this.grid){if(d.indexOf("#")!==0)d="#"+d;var c=a(".navtable",d)[0],n=this;if(c)if(!(b.id&&a("#"+b.id,c).html()!==null)){var E=a("<td></td>");b.buttonicon.toString().toUpperCase()=="NONE"?a(E).addClass("ui-pg-button ui-corner-all").append("<div class='ui-pg-div'>"+
b.caption+"</div>"):a(E).addClass("ui-pg-button ui-corner-all").append("<div class='ui-pg-div'><span class='ui-icon "+b.buttonicon+"'></span>"+b.caption+"</div>");b.id&&a(E).attr("id",b.id);if(b.position=="first")c.rows[0].cells.length===0?a("tr",c).append(E):a("tr td:eq(0)",c).before(E);else a("tr",c).append(E);a(E,c).attr("title",b.title||"").click(function(D){a(this).hasClass("ui-state-disabled")||a.isFunction(b.onClickButton)&&b.onClickButton.call(n,D);return false}).hover(function(){a(this).hasClass("ui-state-disabled")||
a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")})}}})},navSeparatorAdd:function(d,b){b=a.extend({sepclass:"ui-separator",sepcontent:""},b||{});return this.each(function(){if(this.grid){if(d.indexOf("#")!==0)d="#"+d;var c=a(".navtable",d)[0];if(c){var n="<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='"+b.sepclass+"'></span>"+b.sepcontent+"</td>";a("tr",c).append(n)}}})},GridToForm:function(d,b){return this.each(function(){if(this.grid){var c=
a(this).jqGrid("getRowData",d);if(c)for(var n in c)a("[name="+a.jgrid.jqID(n)+"]",b).is("input:radio")||a("[name="+a.jgrid.jqID(n)+"]",b).is("input:checkbox")?a("[name="+a.jgrid.jqID(n)+"]",b).each(function(){a(this).val()==c[n]?a(this).attr("checked","checked"):a(this).attr("checked","")}):a("[name="+a.jgrid.jqID(n)+"]",b).val(c[n])}})},FormToGrid:function(d,b,c,n){return this.each(function(){if(this.grid){c||(c="set");n||(n="first");var E=a(b).serializeArray(),D={};a.each(E,function(F,s){D[s.name]=
s.value});if(c=="add")a(this).jqGrid("addRowData",d,D,n);else c=="set"&&a(this).jqGrid("setRowData",d,D)}})}})})(jQuery);
...
(function(a){a.jgrid.extend({editRow:function(f,x,m,r,t,y,u,k,s){var g={keys:x||false,oneditfunc:m||null,successfunc:r||null,url:t||null,extraparam:y||{},aftersavefunc:u||null,errorfunc:k||null,afterrestorefunc:s||null,restoreAfterErorr:true},o=a.makeArray(arguments).slice(1),b;b=o[0]&&typeof o[0]=="object"&&!a.isFunction(o[0])?a.extend(g,o[0]):g;return this.each(function(){var d=this,c,j,v=0,q=null,p={},l,e;if(d.grid){l=a(d).jqGrid("getInd",f,true);if(l!==false)if((a(l).attr("editable")||"0")=="0"&&
!a(l).hasClass("not-editable-row")){e=d.p.colModel;a("td",l).each(function(h){c=e[h].name;var A=d.p.treeGrid===true&&c==d.p.ExpandColumn;if(A)j=a("span:first",this).html();else try{j=a.unformat(this,{rowId:f,colModel:e[h]},h)}catch(n){j=e[h].edittype&&e[h].edittype=="textarea"?a(this).text():a(this).html()}if(c!="cb"&&c!="subgrid"&&c!="rn"){if(d.p.autoencode)j=a.jgrid.htmlDecode(j);p[c]=j;if(e[h].editable===true){if(q===null)q=h;A?a("span:first",this).html(""):a(this).html("");var i=a.extend({},e[h].editoptions||
{},{id:f+"_"+c,name:c});if(!e[h].edittype)e[h].edittype="text";if(j=="&nbsp;"||j=="&#160;"||j.length==1&&j.charCodeAt(0)==160)j="";i=a.jgrid.createEl(e[h].edittype,i,j,true,a.extend({},a.jgrid.ajaxOptions,d.p.ajaxSelectOptions||{}));a(i).addClass("editable");A?a("span:first",this).append(i):a(this).append(i);e[h].edittype=="select"&&e[h].editoptions.multiple===true&&a.browser.msie&&a(i).width(a(i).width());v++}}});if(v>0){p.id=f;d.p.savedRow.push(p);a(l).attr("editable","1");a("td:eq("+q+") input",
l).focus();b.keys===true&&a(l).bind("keydown",function(h){h.keyCode===27&&a(d).jqGrid("restoreRow",f,s);if(h.keyCode===13){if(h.target.tagName=="TEXTAREA")return true;a(d).jqGrid("saveRow",f,b);return false}h.stopPropagation()});a.isFunction(b.oneditfunc)&&b.oneditfunc.call(d,f)}}}})},saveRow:function(f,x,m,r,t,y,u){var k={successfunc:x||null,url:m||null,extraparam:r||{},aftersavefunc:t||null,errorfunc:y||null,afterrestorefunc:u||null,restoreAfterErorr:true},s=a.makeArray(arguments).slice(1),g;g=
s[0]&&typeof s[0]=="object"&&!a.isFunction(s[0])?a.extend(k,s[0]):k;var o=false,b=this[0],d,c={},j={},v={},q,p,l;if(!b.grid)return o;l=a(b).jqGrid("getInd",f,true);if(l===false)return o;k=a(l).attr("editable");g.url=g.url?g.url:b.p.editurl;if(k==="1"){var e;a("td",l).each(function(n){e=b.p.colModel[n];d=e.name;if(d!="cb"&&d!="subgrid"&&e.editable===true&&d!="rn"&&!a(this).hasClass("not-editable-cell")){switch(e.edittype){case "checkbox":var i=["Yes","No"];if(e.editoptions)i=e.editoptions.value.split(":");
...
a.jgrid.checkValues(c[d],n,b);if(p[0]===false){p[1]=c[d]+" "+p[1];return false}if(b.p.autoencode)c[d]=a.jgrid.htmlEncode(c[d]);if(g.url!=="clientArray"&&e.editoptions&&e.editoptions.NullIfEmpty===true)if(c[d]=="")v[d]="null"}});if(p[0]===false){try{var h=a.jgrid.findPos(a("#"+a.jgrid.jqID(f),b.grid.bDiv)[0]);a.jgrid.info_dialog(a.jgrid.errors.errcap,p[1],a.jgrid.edit.bClose,{left:h[0],top:h[1]})}catch(A){alert(p[1])}return o}if(c){k=b.p.prmNames;s=k.oper;h=k.id;c[s]=k.editoper;c[h]=f;if(typeof b.p.inlineData==
"undefined")b.p.inlineData={};c=a.extend({},c,b.p.inlineData,g.extraparam)}if(g.url=="clientArray"){c=a.extend({},c,j);b.p.autoencode&&a.each(c,function(n,i){c[n]=a.jgrid.htmlDecode(i)});h=a(b).jqGrid("setRowData",f,c);a(l).attr("editable","0");for(k=0;k<b.p.savedRow.length;k++)if(b.p.savedRow[k].id==f){q=k;break}q>=0&&b.p.savedRow.splice(q,1);a.isFunction(g.aftersavefunc)&&g.aftersavefunc.call(b,f,h);o=true}else{a("#lui_"+b.p.id).show();v=a.extend({},c,v);a.ajax(a.extend({url:g.url,data:a.isFunction(b.p.serializeRowData)?
b.p.serializeRowData.call(b,v):v,type:"POST",async:false,complete:function(n,i){a("#lui_"+b.p.id).hide();if(i==="success")if((a.isFunction(g.successfunc)?g.successfunc.call(b,n):true)===true){b.p.autoencode&&a.each(c,function(z,B){c[z]=a.jgrid.htmlDecode(B)});c=a.extend({},c,j);a(b).jqGrid("setRowData",f,c);a(l).attr("editable","0");for(var w=0;w<b.p.savedRow.length;w++)if(b.p.savedRow[w].id==f){q=w;break}q>=0&&b.p.savedRow.splice(q,1);a.isFunction(g.aftersavefunc)&&g.aftersavefunc.call(b,f,n);o=
true}else{a.isFunction(g.errorfunc)&&g.errorfunc.call(b,f,n,i);g.restoreAfterError===true&&a(b).jqGrid("restoreRow",f,g.afterrestorefunc)}},error:function(n,i){a("#lui_"+b.p.id).hide();if(a.isFunction(g.errorfunc))g.errorfunc.call(b,f,n,i);else try{jQuery.jgrid.info_dialog(jQuery.jgrid.errors.errcap,'<div class="ui-state-error">'+n.responseText+"</div>",jQuery.jgrid.edit.bClose,{buttonalign:"right"})}catch(w){alert(n.responseText)}g.restoreAfterError===true&&a(b).jqGrid("restoreRow",f,g.afterrestorefunc)}},
a.jgrid.ajaxOptions,b.p.ajaxRowOptions||{}))}a(l).unbind("keydown")}return o},restoreRow:function(f,x){return this.each(function(){var m=this,r,t,y={};if(m.grid){t=a(m).jqGrid("getInd",f,true);if(t!==false){for(var u=0;u<m.p.savedRow.length;u++)if(m.p.savedRow[u].id==f){r=u;break}if(r>=0){if(a.isFunction(a.fn.datepicker))try{a("input.hasDatepicker","#"+a.jgrid.jqID(t.id)).datepicker("hide")}catch(k){}a.each(m.p.colModel,function(){if(this.editable===true&&this.name in m.p.savedRow[r]&&!a(this).hasClass("not-editable-cell"))y[this.name]=
m.p.savedRow[r][this.name]});a(m).jqGrid("setRowData",f,y);a(t).attr("editable","0").unbind("keydown");m.p.savedRow.splice(r,1)}a.isFunction(x)&&x.call(m,f)}}})}})})(jQuery);
