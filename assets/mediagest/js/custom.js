$(document).ready(function() {
	...
	$(window).bind("load resize", function(){
		if ($("nav").width() > 100) {
			$("nav ul li:has(ul)").hover(function(){
                                ...
                                $(this).find("ul.submenu").stop(true,true, true).slideDown(500);

			}, function(){

				$(this).find("ul.submenu").stop(true,true, true).delay(100).slideUp(500);
				/*$(this).find("ul.submenu").stop(true,false, false).slideDown(500);
			}, function(){
				$(this).find("ul.submenu").stop(true,false, false).delay(100).slideUp(500);*/
			});
		} else {
			$("nav ul li ul").empty();
		}
	...
	// if (!$.browser.webkit && !$.browser.safari && !$.browser.opera && !$.browser.msie  !$.browser.mozilla) {
