...
/* Translated by Sinan Eldem - www.sinaneldem.com.tr */
	...
	$lang['list_paging_of'] 		= '#';
	$lang['list_displaying']		= 'Toplam {results} kayıttan {start} ile {end} arası gösteriliyor';
	$lang['list_filtered_from']		= '{total_results} toplam kayıttan filtrelendi';
	$lang['list_show_entries']		= 'Sayfa başına {paging} kayıt göster';
	$lang['list_no_items']			= 'Gösterilecek kayıt bulunamadı';
	$lang['list_zero_entries']		= '0 kayıttan 0 ile 0 arası gösteriliyor';
	$lang['list_search'] 			= 'Arama';	
	$lang['list_search_all'] 		= 'Tümünü ara';
	$lang['list_clear_filtering'] 	= 'Filtreyi temizle';
	$lang['list_delete'] 			= 'Sil';
	$lang['list_edit'] 				= 'Düzenle';	
	$lang['list_paging_first'] 		= 'İlk';
	$lang['list_paging_previous'] 	= 'Önceki';
