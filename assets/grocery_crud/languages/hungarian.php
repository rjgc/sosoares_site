...
/* Translated by: Wathfea */
    ...
    $lang['list_paging_of']         = 'összesen';
    $lang['list_displaying']        = '{start} elem a(z) {end}-ből . Összesesen {results} elem';
    $lang['list_filtered_from']     = '(Kiválasztva összesen {total_results} elemből)';
    $lang['list_show_entries']      = '{paging} db mutatása';
    $lang['list_no_items']          = 'Nincs megjelenítendő elem';
    ...
    $lang['list_paging_next']       = 'Következő';
    $lang['list_paging_last']       = 'Utolsó';
    ...
    $lang['form_go_back_to_list']   = 'Vissza a listához';

    $lang['form_add']               = 'Hozzáadás';
    $lang['insert_success_message'] = 'Az adatok sikeresen elmentve az adatbázisba.';
    $lang['form_or']                = 'vagy';
    $lang['form_save']              = 'Mentés';
    $lang['form_insert_loading']    = 'Betöltés, adatok mentése...';

    $lang['form_upload_a_file']     = 'Fájl feltöltése';
