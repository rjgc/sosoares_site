...
class Migration_Install_ion_auth extends CI_Migration {
	...
	public function up()
	{
		...
		// Drop table 'users_auth' if it exists
		...
		// Drop table 'users_auth_groups' if it exists		
		$this->dbforge->drop_table('users_auth_groups');

		// Table structure for table 'users_auth_groups'
		$this->dbforge->add_field(array(
			'id' => array(
				'type' => 'MEDIUMINT',
				'constraint' => '8',
		...
		$this->dbforge->add_key('id', TRUE);
		$this->dbforge->create_table('users_auth_groups');

		// Dumping data for table 'users_auth_groups'
		$data = array(
			array(
				'id' => '1',
				'user_id' => '1',
		...
		$this->db->insert_batch('users_auth_groups', $data);
