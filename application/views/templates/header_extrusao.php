                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <span id="img">
                                ...
                                <a href="<?php echo site_url('pages/home_extrusao')?>"><img src="<?php echo base_url() ?>assets/sosoares/img/p_extrusao_a.png" width="49" height="49" alt="Extrusão" title="Extrusão" class="grow"></a>
            ...
            <div class="navbar navbar-default yamm">
                ...
                <div id="navbar-collapse-grid" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        <li class="menu-title"><a href="<?php echo site_url('pages/home_extrusao')?>">Início</a></li>
