...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>assets/sosoares/css/styles-abrasivos.css">
        ...
        <header>
            <div class="content">
                <div class="container">
                    <div class="row">
                        <div class="col-md-3">
                            <a href="<?php echo site_url('home')?>"><img src="<?php echo base_url() ?>assets/sosoares/img/logotipo.png" width="210" height="47" alt="GRUPO SOSOARES" title="GRUPO SOSOARES" class="grow"/></a>
                        </div>
                        <div class="col-md-5">
                            <span id="img">
                                <a href="<?php echo site_url('pages/home_caixilharia')?>"><img src="<?php echo base_url() ?>assets/sosoares/img/p_caixilharia.png" width="49" height="49" alt="Caixilharia" title="Caixilharia" class="grow"></a>
                                ...
                                <a href="<?php echo site_url('pages/home_tratamento')?>"><img src="<?php echo base_url() ?>assets/sosoares/img/p_abrasivos_a.png" width="49" height="49" alt="Abrasivos" title="Abrasivos" class="grow"></a>
                            </span>
                        </div>
                        <div class="col-md-2">
            ...
            <div class="navbar navbar-default yamm">
                ...
                <div id="navbar-collapse-grid" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        <li class="menu-title"><a href="<?php echo site_url('pages/home_tratamento')?>">Início</a></li>
