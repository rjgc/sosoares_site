                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <span id="img">
                                ...
                                <a href="<?php echo site_url('pages/home_vidro')?>"><img src="<?php echo base_url() ?>assets/sosoares/img/p_vidro_a.png" width="49" height="49" alt="Vidro" title="Vidro" class="grow"></a>
            ...
            <div class="navbar navbar-default yamm">
                ...
                <div id="navbar-collapse-grid" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        <li class="menu-title"><a href="<?php echo site_url('pages/home_vidro')?>">Início</a></li>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    <h3 class="menu-h3">Orçamentação</h3>
                                                    <ul>
                                                        <li><b class="li-b">Something</b>
                                                            <ul>
                                                                <li><a href="#">Something</a></li>
