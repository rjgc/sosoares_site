        ...
        <div class="container">
            <div class="row">
                ...
                <div class="pages-img">
                    ...
                    <a href="<?php echo site_url('pages/home_vidro')?>"><i class="icon-vidro grow font font-active"></i></a>
                ...
                <div id="bd">
                    <a href="<?php echo site_url('pages/home_vidro')?>"><img src="<?php echo base_url() ?>assets/sosoares/img/bd_pt.png" width="22" height="15" alt="Portugal" title="Portugal" class="grow"></a>
                    <a href="<?php echo site_url('pages/home_vidro')?>"><img src="<?php echo base_url() ?>assets/sosoares/img/bd_uk.png" width="22" height="15" alt="United Kingdom" title="United Kingdom" class="grow"></a>
                    <a href="<?php echo site_url('pages/home_vidro')?>"><img src="<?php echo base_url() ?>assets/sosoares/img/bd_fr.png" width="22" height="15" alt="France" title="France" class="grow"></a>
                    <a href="<?php echo site_url('pages/home_vidro')?>"><img src="<?php echo base_url() ?>assets/sosoares/img/bd_sp.png" width="22" height="15" alt="Spain" title="Spain" class="grow"></a>
                </div>
                <div id="signIn">
        ...
        <div class="navbar navbar-default yamm">
            ...
            <div id="navbar-collapse-grid" class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    <li class="menu-title <?php echo ( isset($current) && $current === 'home_vidro' ) ? 'curr' : ''?>"><a href="<?php echo site_url('pages/home_caixilharia')?>">Início</a></li>
                    <li class="menu-title <?php echo ( isset($current) && $current === 'grupo_caixilharia' ) ? 'curr' : ''?>"><a href="#">Grupo Sosoares</a></li>
                    <li class="dropdown yamm-fw menu-title <?php echo ( isset($current) && $current === 'produto_caixilharia' ) ? 'curr' : ''?>"><a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="100" data-close-others="false">Produtos Vidro</a>
