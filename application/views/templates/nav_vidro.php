                        ...
                        <div class="row">
                            <div class="col-sm-3">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <h3 class="menu-h3 links"><a href="<?=site_url('vidro/grupo_sosoares/5')?>"><?=lang('quem')?></a></h3>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-3">
                ...
                <li class="grid-demo">
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="row">
                                <div class="col-sm-6">
                                <h3 class="menu-h3 links"><a href="<?=site_url('vidro/apoio_cliente/1')?>"><?=lang('comercial')?></a></h3>
                                </div>
                                <div class="col-sm-6">
                                    <h3 class="menu-h3 links"><a href="<?=site_url('vidro/apoio_cliente/2')?>"><?=lang('orcamentacao')?></a></h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="row">
                                <div class="col-sm-6">
                                    <h3 class="menu-h3 links"><a href="<?=site_url('vidro/apoio_cliente/7')?>"><?=lang('vfaqs')?></a></h3>
                                </div>
                            </div>
                        </div>
                    </div>
