<div class="container">
    ...
    <div class="alert alert-warning">
        <h5><strong>Atenção!</strong> Tem de seleccionar um produto. <a href="<?=site_url('pages/produtos_vidro')?>">Voltar atrás.</a></h5>
    </div>
</div>
<?php } else { ?>
    <li><a href="<?=site_url('pages/produto_vidro/'.$produto['id_produto_vidro'])?>"><?=$produto['nome_'.$this->lang->lang()]?></a></li>
    </ul>
