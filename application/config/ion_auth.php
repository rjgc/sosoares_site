...
|
*/
$config['collections']['users_auth']          = 'users_auth';
...
*/
$config['tables']['users_auth']           = 'users_auth';
$config['tables']['groups']          = 'groups';
$config['tables']['users_auth_groups']    = 'users_auth_groups';
$config['tables']['login_attempts']  = 'login_attempts';

/*
 | users_auth table column and Group table column you want to join WITH.
 |
 | Joins from users_auth.id
 | Joins from groups.id
 */
$config['join']['users_auth']  = 'user_id';
...
$config['remember_users_auth']             = TRUE;                // Allow users_auth to be remembered and enable auto-login
$config['user_expire']                = 86500;               // How long to remember the user (seconds). Set to zero for no expiration
$config['user_extend_on_login']       = FALSE;               // Extend the users_auth cookies every time they auto-login
