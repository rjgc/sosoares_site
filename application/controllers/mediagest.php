...
// $crud->set_relation_n_n('products', 'product_related_case_studies', 'product', 'case_studies', 'product_id', 'name', 'priority');
	...
	function ficheiros_management(){
		...
		$crud->columns('nome_ficheiro');
		$crud->display_as('nome_ficheiro', 'Nome');
		...
		$crud->set_field_upload('nome_ficheiro','assets/uploads/files');
		$crud->display_as('nome_ficheiro', 'Ficheiro');
		$crud->display_as('id_categoria_ficheiro', 'Categoria');
		$crud->display_as('ficheiro', 'Nome');
...
//$crud->set_theme('flexigrid');
		...
		$crud->fields('nome', 'descricao', 'id_tipo_produto_aluminio','id_caracteristica_produto_aluminio', 'foto_1', 'foto_2', 'foto_3', 'foto_4', 'corte_1', 'corte_2', 'corte_3', 'ensaios_aluminio');
