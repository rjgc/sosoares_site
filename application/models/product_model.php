...
class Product_model extends CI_Model
{
	...
	public function get_aluminios_madeira(){
		$query = $this->db->query("select pa.nome_pt, pa.id_produto_aluminio, pa.foto_1 from produtos_aluminio pa inner join tipos_produto_aluminio tpa on pa.id_tipo_produto_aluminio = tpa.id_tipo_produto_aluminio and tpa.nome_pt = 'Aluminio Madeira'");
	...
	public function get_gradeamentos(){
		$query = $this->db->query("select pa.nome_pt, pa.id_produto_aluminio, pa.foto_1 from produtos_aluminio pa inner join tipos_produto_aluminio tpa on pa.id_tipo_produto_aluminio = tpa.id_tipo_produto_aluminio and tpa.nome_pt = 'Gradeamentos'");
	...
	public function get_fachadas(){
		$query = $this->db->query("select pa.nome_pt, pa.id_produto_aluminio, pa.foto_1 from produtos_aluminio pa inner join tipos_produto_aluminio tpa on pa.id_tipo_produto_aluminio = tpa.id_tipo_produto_aluminio and tpa.nome_pt = 'Fachada/Quebra-Sol'");
	...
	public function get_portadas(){
		$query = $this->db->query("select pa.nome_pt, pa.id_produto_aluminio, pa.foto_1 from produtos_aluminio pa inner join tipos_produto_aluminio tpa on pa.id_tipo_produto_aluminio = tpa.id_tipo_produto_aluminio and tpa.nome_pt = 'Portadas'");
	...
	public function get_portoes(){
		$query = $this->db->query("select pa.nome_pt, pa.id_produto_aluminio, pa.foto_1 from produtos_aluminio pa inner join tipos_produto_aluminio tpa on pa.id_tipo_produto_aluminio = tpa.id_tipo_produto_aluminio and tpa.nome_pt = 'Portões'");
	...
	public function get_standards(){
		$query = $this->db->query("select pa.nome_pt, pa.id_produto_aluminio, pa.foto_1 from produtos_aluminio pa inner join tipos_produto_aluminio tpa on pa.id_tipo_produto_aluminio = tpa.id_tipo_produto_aluminio and tpa.nome_pt = 'Standards'");
